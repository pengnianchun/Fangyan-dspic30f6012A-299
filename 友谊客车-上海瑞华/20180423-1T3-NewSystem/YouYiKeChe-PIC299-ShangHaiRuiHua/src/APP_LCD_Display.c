...
CAN_WARN_LIST list[CAN_LIST_NUMBER] = {
    ...
    {clcs, 8},//车辆超速
    {qmwyjfbj, 9},//前门外应急阀报警
    {zmwyjfbj, 10},//中门外应急阀报警
    {qmnyjfbj, 11},//前门内应急阀报警
    {zmnyjfbj, 12},//中门内应急阀报警
    {zpl, 13},//左偏离
    {ypl, 14},//右偏离
    {pzbjyx, 15},//碰撞预警有效
    {reserve, 16},//备用
...
static void CAN_WARN_UPDATE(void) {
    ...
    list[7].condition = (rKL11);
    list[8].condition = (SPEED > 69);
    list[9].condition = (fKL10);
    list[10].condition = (fKL12);
    list[11].condition = (mKL4);
    list[12].condition = (mKL6);
    list[13].condition = (CAN_0x10F007E8.Lane_Depature_Left == 1);
    list[14].condition = (CAN_0x10F007E8.Lane_Depature_Right == 1);
    list[15].condition = (CAN_0x10F007E8.warning);
    list[16].condition = 0;
    list[17].condition = 0;
    list[18].condition = (IN17 && !LED18);
    list[19].condition = (CAN_0x10F8159E.BMS_BasicStatus > 0);
    list[20].condition = (CAN_0x08F8189E.HVILStatus > 0);
    list[21].condition = 0;
    list[22].condition = (CAN_0x08019F80.Notice3.bit4);
    list[23].condition = 0;
    list[24].condition = 0;
    list[25].condition = 0;
    list[26].condition = 0;
    list[27].condition = 0;
    list[28].condition = 0;
    list[29].condition = (((CAN_0x08F8189E.SOCFaultStatus >> 4) & 0x03) > 0);
    list[30].condition = (CAN_0x08F8189E.StoredEnergySYSMismatchWarning > 0);
    list[31].condition = (CAN_0x08F8189E.BMS_CellUniformityStatus > 0);
    list[32].condition = 0;
    list[33].condition = (((CAN_0x08F8189E.TotalVoltageFaultStatus & 0x03) > 0) || (CAN_0x08019F80.Notice3.bit1));
    list[34].condition = ((((CAN_0x08F8189E.TotalVoltageFaultStatus >> 2) & 0x03) > 0) || (CAN_0x08019F80.Notice3.bit2));
    list[35].condition = ((CAN_0x08F8189E.CellVoltageFaultStatus & 0x03) > 0);
    list[36].condition = ((((CAN_0x08F8189E.CellVoltageFaultStatus >> 2) & 0x03) > 0) || (CAN_0x08019F80.Notice3.bit3));
    list[37].condition = 0;
    list[38].condition = (((CAN_0x08F8189E.TempFaultStatus >> 4)& 0x03) > 0);
    list[39].condition = ((CAN_0x08F8189E.TempFaultStatus& 0x03) > 0);
    list[40].condition = ((((CAN_0x08F8189E.TempFaultStatus >> 2)& 0x03) > 0) || (CAN_0x08019F80.Notice3.bit5));
    list[41].condition = ((CAN_0x08F8189E.CurrentFault & 0x03) > 0);
    list[42].condition = (((CAN_0x08F8189E.CurrentFault >> 2)& 0x03) > 0);
    list[43].condition = (((CAN_0x08F8189E.SOCFaultStatus >> 2) & 0x03) > 0);
    list[44].condition = ((CAN_0x08F8189E.SOCFaultStatus & 0x03) > 0);
    list[45].condition = 0;
    list[46].condition = 0;
    list[47].condition = 0;
    list[48].condition = (CAN_0x08F8189E.BMSInsideFault > 0);
    list[49].condition = (CAN_0x08019F80.Notice1.bit2);
    list[50].condition = (CAN_0x08019F80.Notice1.bit7);
    list[51].condition = ((CAN_0x08F8189E.InsulationResisitanceFaultStatus > 0) || (CAN_0x08019F80.Notice1.bit5));
    list[52].condition = 0;
    list[53].condition = 0;
    list[54].condition = (CAN_0x08019F80.Notice2.bit1);
    list[55].condition = (CAN_0x08019F80.Notice1.bit4);
    list[56].condition = 0;
    list[57].condition = 0;
    list[58].condition = 0;
    list[59].condition = 0;
    ...
    list[64].condition = 0;
    list[65].condition = 0;
    list[66].condition = (CAN_0x08029F80.MotorCtrlTemp > 130);
    list[67].condition = (CAN_0x08019F80.Notice1.bit3);
    list[68].condition = 0;
    list[69].condition = (CAN_0x08029F80.DriveMotorTemp > 150);
    list[70].condition = 0;
    list[71].condition = 0;
    list[72].condition = 0;
    list[73].condition = 0;
    ...
    list[94].condition = 0;
    list[95].condition = 0;
    list[96].condition = ((CAN_0x08019F80.Notice2.bit7) || (CAN_0x142CFF98.DCDC_Status == 2));
    list[97].condition = 0;
    list[98].condition = ((CAN_0x08019F80.Notice2.bit8) || (CAN_0x1429FF9B.DCAC_PumpStatus == 2));
    list[99].condition = (CAN_0x08019F80.Notice2.bit2); 
}
#define BLANK  350
...
void disp_BMP_baojing(void) {
    ...
    if (CAN_0x08F8189E.InsulationResisitanceFaultStatus || CAN_0x08019F80.Notice1.bit5) 
        color = RED;
    else 
        color = GRAY;
    ...
    if (CAN_0x08019F80.Notice1.bit4)
        color = RED;
    else 
        color = GRAY;
    if (color_old[7] != color) {
        color_old[7] = color;
        LCD_DrawImage1BPP(8 + 66 * 7, 10, Bmp_baojing[10], color, BLACK); //电机过温
    ...
    if (CAN_0x08019F80.Notice3.bit4)
        color = RED;
    else 
        color = GRAY;
    ...
    if (CAN_0x08019F80.Notice2.bit2)
        color = YELLOW;
    else 
        color = GRAY;
    ...
    if (CAN_0x08019F80.Notice1.bit1) 
        color = GREEN;
    else 
        color = GRAY;
...
void updata_Dangwei(unsigned int x, unsigned int y) {//0 : N;  1：D;  2 :R;  3：P
    ...
    if (CAN_0x08019F80.Gear == 2) gear = 0;
    else if (CAN_0x08019F80.Gear == 3) gear = 1;
    else if (CAN_0x08019F80.Gear == 1) gear = 2;
    else if (CAN_0x08019F80.Gear == 0) gear = 3;
    else gear = 0;
...
void updata_DCDY(unsigned int x, unsigned int y,float factor) {
    ...
    DCDY = CAN_0x10F8159E.BMS_Voltage * factor;
    if (DCDY >= 800)
        DCDY = 800;
...
void updata_DCDL(unsigned int x, unsigned int y,float factor,unsigned int offset) {
    ...
    DCDL = CAN_0x10F8159E.BMS_Current * factor;
    if (DCDL < offset) {
        DCDL = offset - DCDL;
...
void updata_DAT(unsigned int x, unsigned int y, //带符号数值
    ...
    if (DAT < offset) {
        ...
        LCD_DrawImage1BPPZOOM_4(x - 25, y + 5, BMP_ASIC_11x20[45 - 32], color1, BLACK);
    } else {
        LCD_DrawImage1BPPZOOM_4(x - 25, y + 5, BMP_ASIC_11x20[43-32], BLACK, BLACK);
...
void ICFrame(unsigned char index) { //仪表框架
    ...
    if (index == 1) {
        ...
        /*************************第一列开关***********************************/
        //IN1  左转向开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 0, zzxkg, WHITE, BLACK);
        //IN2
        //IN3      
        //IN4
        //IN5  右转向开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 4, yzxkg, WHITE, BLACK);
        //IN6  小灯开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 5, xdkg, WHITE, BLACK);      
        //IN7  远光灯
        LCD_DrawImageString_21x20(35, 75 + 25 * 6, ygdkg, WHITE, BLACK);
        //IN8  近光灯
        LCD_DrawImageString_21x20(35, 75 + 25 * 7, jgdkg, WHITE, BLACK);
        //IN9  前雾灯
        LCD_DrawImageString_21x20(35, 75 + 25 * 8, qwdkg, WHITE, BLACK);
        //IN10 后雾灯
        LCD_DrawImageString_21x20(35, 75 + 25 * 9, hwdkg, WHITE, BLACK);
        //IN11 司机灯开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 10, sjdkg, WHITE, BLACK);
        //IN12 长条灯1开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 11, ctd1kg, WHITE, BLACK);
        //IN13 电视开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 12, dskg, WHITE, BLACK);
        //IN14 雨刮低档开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 13, ygdkg, WHITE, BLACK);
        //IN15 雨刮间歇档开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 14, ygjxdkg, WHITE, BLACK);
        //IN16 雨刮高档开关
        LCD_DrawImageString_21x20(35, 75 + 25 * 15, yggdkg, WHITE, BLACK);
        /*************************第二列开关***********************************/
        //IN17 驾驶员离开信号
        LCD_DrawImageString_21x20(285, 75 + 25 * 0, zlbj, WHITE, BLACK);
        //IN18 ABS工作指示灯
        LCD_DrawImageString_21x20(285, 75 + 25 * 1, absgzzs, WHITE, BLACK);
        //IN19 
        //IN20 前门开开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 3, qmkkg, WHITE, BLACK);
        //IN21 雨刮喷水开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 4, ygpsdj, WHITE, BLACK);
        //IN22 电喇叭开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 5, dlbkg, WHITE, BLACK);
        //IN23 
        //IN24 安全带报警
        LCD_DrawImageString_21x20(285, 75 + 25 * 7, aqdbj, WHITE, BLACK);
        //IN25 长条灯2开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 8, ctd2kg, WHITE, BLACK);
        //IN26 中门关开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 9, zmgkg, WHITE, BLACK);
        //IN27 中门开开关 
        LCD_DrawImageString_21x20(285, 75 + 25 * 10, zmkkg, WHITE, BLACK);
        //IN28 前门关开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 11, qmgkg, WHITE, BLACK);
        //IN29 
        //IN30 
        //IN31 排气扇进气开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 14, pqsjqkg, WHITE, BLACK);
        //IN32 排气扇排气开关
        LCD_DrawImageString_21x20(285, 75 + 25 * 15, pqspqkg, WHITE, BLACK);
        ...
        //IN37 
        //IN38 危险报警开关
        LCD_DrawImageString_21x20(535, 75 + 25 * 5, wxbjkg, WHITE, BLACK);
        //IN39 充电唤醒
        LCD_DrawImageString_21x20(535, 75 + 25 * 6, cdhx, WHITE, BLACK);
        //IN40 ON档唤醒
        LCD_DrawImageString_21x20(535, 75 + 25 * 7, onhx, WHITE, BLACK);
        
        LCD_DrawImageString_21x20(535, 75 + 25 * 8, mnxh1, WHITE, BLACK);
        LCD_DrawImageString_21x20(535, 75 + 25 * 9, mnxh2, WHITE, BLACK);
        LCD_DrawImageString_21x20(535, 75 + 25 * 10, mnxh3, WHITE, BLACK);
        LCD_DrawImageString_21x20(535, 75 + 25 * 11, mnxh4, WHITE, BLACK);
        LCD_DrawImageString_21x20(535, 75 + 25 * 12, mnxh5, WHITE, BLACK);
        LCD_DrawImageString_21x20(535, 75 + 25 * 13, mnxh6, WHITE, BLACK);
        for (i = 8; i < 14; i++) {
        ...
        /*************************前模块输出***********************************/
        //OUT1  雨刮高档电机
        LCD_DrawImageString_21x20(60, 75 + 25 * 0,yggddj, WHITE, BLACK);
        //OUT2  雨刮低档电机
        LCD_DrawImageString_21x20(60, 75 + 25 * 1,ygdddj, WHITE, BLACK);
        //OUT3  雨刮喷水电机
        LCD_DrawImageString_21x20(60, 75 + 25 * 2, ygpsdj, WHITE, BLACK);
        //OUT4  左前雾灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 3, zqwd, WHITE, BLACK);      
        //OUT5  空调电源
        LCD_DrawImageString_21x20(60, 75 + 25 * 4, ktdy, WHITE, BLACK);   
        //OUT6  右转向灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 5, yzxd, WHITE, BLACK);   
        //OUT7  左转向灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 6, zzxd, WHITE, BLACK);   
        //OUT8  投币机翻板信号输出
        LCD_DrawImageString_21x20(60, 75 + 25 * 7, dysc, WHITE, BLACK);
        //OUT9  左远光灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 8,zygd, WHITE, BLACK);
        //OUT10 右前雾灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 9, yqwd, WHITE, BLACK);
        //OUT11 右远光灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 10, yygxd, WHITE, BLACK);
        //OUT12 前门踏步灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 11, qmd, WHITE, BLACK);
        //OUT13 左近光灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 12, zjgd, WHITE, BLACK);
        //OUT14 位置灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 13, wzd, WHITE, BLACK);
        //OUT15 右近光灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 14, yjgd, WHITE, BLACK);
        //ADD
        LCD_DrawImageString_21x20(60, 75 + 25 * 15, add, WHITE, BLACK);
        /***********************前模块开关采集*********************************/
        //KL1 门铃开关
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 0, mlkg, WHITE, BLACK);
        //KL2 左前摩擦片
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 1, zqmcp, WHITE, BLACK);
        //KL3  
        //KL4 右前摩擦片
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 3, yqmcp, WHITE, BLACK);
        //KL5  
        //KL6 制动开关
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 5, zdkg, WHITE, BLACK);
        //KL7  
        //KL8 司机风扇
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 7, sjfskg, WHITE, BLACK);
        //KL9  
        //KL10 前门外应急阀报警
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 9, qmwyjfbj, WHITE, BLACK);
        //KL11 
        //KL12 中门外应急阀报警
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 11, zmwyjfbj, WHITE, BLACK);
        //KL12 
        //KL13 地址选择1
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 12, dzxz1, WHITE, BLACK);
        //KL14 地址选择2
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 13, dzxz2, WHITE, BLACK);
        //KL15 
        //KH1  中门开信号
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 15, zmkxh, WHITE, BLACK);

        LCD_DrawImageString_21x20(535 + 63 - 11, 75 + 25 * 0, xh1, WHITE, BLACK);
        LCD_DrawImage1BPP(535 + 63 + 42 + 16 * 4 - 4, 75 + 25 * 0, BMP_Omu, WHITE, BLACK); //Ω
        LCD_DrawImage1BPP_11x20(535 + 63 + 42 + 16 * 4 + 16 * 5, 75 + 25 * 0, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V
        
        LCD_DrawImageString_21x20(535 + 63 - 11, 75 + 25 * 1, xh2, WHITE, BLACK);
        LCD_DrawImage1BPP(535 + 63 + 42 + 16 * 4 - 4, 75 + 25 * 1, BMP_Omu, WHITE, BLACK); //Ω
        LCD_DrawImage1BPP_11x20(535 + 63 + 42 + 16 * 4 + 16 * 5, 75 + 25 * 1, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V
        ...
        /*********************顶模块输出***************************************/
        //OUT1  长条灯1
        LCD_DrawImageString_21x20(60, 75 + 25 * 0,ctd1, WHITE, BLACK);
        //OUT2  右转向灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 1,yzxd, WHITE, BLACK);
        //OUT3  司机灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 2, sjd, WHITE, BLACK);
        //OUT4  制动灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 3, zdd, WHITE, BLACK);      
        //OUT5  前门开门电磁阀
        LCD_DrawImageString_21x20(60, 75 + 25 * 4, qmksc, WHITE, BLACK);   
        //OUT6  长条灯2
        LCD_DrawImageString_21x20(60, 75 + 25 * 5, ctd2, WHITE, BLACK);   
        //OUT7  前门关门电磁阀
        LCD_DrawImageString_21x20(60, 75 + 25 * 6, qmgsc, WHITE, BLACK);   
        //OUT8  司机风扇
        LCD_DrawImageString_21x20(60, 75 + 25 * 7, sjfs, WHITE, BLACK);
        //OUT9  中门开门电磁阀
        LCD_DrawImageString_21x20(60, 75 + 25 * 8,zmksc, WHITE, BLACK);
        //OUT10 门泵电源
        LCD_DrawImageString_21x20(60, 75 + 25 * 9, mdy, WHITE, BLACK);
        //OUT11 中门关门电磁阀
        LCD_DrawImageString_21x20(60, 75 + 25 * 10, zmgsc, WHITE, BLACK);
        //OUT12 
        //OUT13 电视输出
        LCD_DrawImageString_21x20(60, 75 + 25 * 12, dssc, WHITE, BLACK);
        //OUT14 位置灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 13, wzd, WHITE, BLACK);
        //OUT15 左转向灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 14, zzxd, WHITE, BLACK);          
        /************************顶模块开关*********************************/
        //KL1 
        //KL2 
        //KL3  
        //KL4 前门内应急阀报警
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 3, qmnyjfbj, WHITE, BLACK);
        //KL5  
        //KL6 中门内应急阀报警
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 5, zmnyjfbj, WHITE, BLACK);
        //KL7  
        //KL8 
        //KL9  
        //KL10 
        ...
        //KL15 
        //KH1  前门开信号
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 15, qmkxh, WHITE, BLACK);
        ...
        /*********************后模块输出***************************************/
        //OUT1  制动灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 0,zdd, WHITE, BLACK);
        //OUT2  冷凝器电源
        LCD_DrawImageString_21x20(60, 75 + 25 * 1,lqdy, WHITE, BLACK);
        //OUT3  后雾灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 2, hwd, WHITE, BLACK);
        //OUT4       
        //OUT5  左转向灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 4, zzxd, WHITE, BLACK);   
        //OUT6  气压传感器电源
        LCD_DrawImageString_21x20(60, 75 + 25 * 5, qydy, WHITE, BLACK);   
        //OUT7  右转向灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 6, yzxd, WHITE, BLACK);   
        //OUT8  电喇叭1
        LCD_DrawImageString_21x20(60, 75 + 25 * 7, dlb1, WHITE, BLACK);
        //OUT9  倒车灯1
        LCD_DrawImageString_21x20(60, 75 + 25 * 8,dcd1, WHITE, BLACK);
        //OUT10 电喇叭2
        LCD_DrawImageString_21x20(60, 75 + 25 * 9, dlb2, WHITE, BLACK);
        //OUT11 位置灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 10, wzd, WHITE, BLACK);
        //OUT12 位置灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 11, wzd, WHITE, BLACK);
        //OUT13 中门踏步灯
        LCD_DrawImageString_21x20(60, 75 + 25 * 12, hmd, WHITE, BLACK);
        //OUT14 倒车喇叭
        LCD_DrawImageString_21x20(60, 75 + 25 * 13, dclb, WHITE, BLACK);
        //OUT15 倒车灯2
        LCD_DrawImageString_21x20(60, 75 + 25 * 14, dcd2, WHITE, BLACK);                    
        /*********************后模块开关***************************************/
        //KL1 水位传感器开关(接地报警)
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 0, swbj, WHITE, BLACK);
        //KL2 
        //KL3  
        //KL4 
        //KL5  
        ...
        //KL7  
        //KL8  驻车制动开关
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 7, zczdkg, WHITE, BLACK);
        //KL9  
        //KL10 
        //KL11 后仓门开关(控负)
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 10, hcmkg, WHITE, BLACK);
        //KL12 
        //KL12 
        //KL13 地址选择1
        LCD_DrawImageString_21x20(285 + 150, 75 + 25 * 12, dzxz1, WHITE, BLACK);
...
void MenuFrame(void) {
    ...
    LCD_DrawImageSBPP(130 + 350, 130 + 35 * 1, 50, IC_SYSTEM, color, BLACK); //仪表
...
void MOTOFrame(unsigned char index) {
    ...
    if (index == 1) {
        LCD_DrawImageString_21x20(82, 100, djsrdy, WHITE, BLACK); //电机母线电压
        LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 0, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V

        LCD_DrawImageString_21x20(82, 100 + 38, djsrdl, WHITE, BLACK); //电机母线电流
        LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 1, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V

        LCD_DrawImageString_21x20(82, 100 + 38 * 2, djwd, WHITE, BLACK); //电机温度
        LCD_DrawImage1BPP(400 - 24, 100 + 38 * 2, BMP_T, WHITE, BLACK); //V

        LCD_DrawImageString_21x20(82, 100 + 38 * 3, kzqwd, WHITE, BLACK); //
        LCD_DrawImage1BPP(400 - 28, 100 + 38 * 3, BMP_T, WHITE, BLACK); //℃

        //LCD_DrawImageString_21x20(82, 100 + 38 * 4, DJGZDM, WHITE, BLACK); //电机故障代码

        //LCD_DrawImageString_21x20(82, 100 + 38 * 5, DJGZDJ, WHITE, BLACK); //电机故障等级

        //LCD_DrawImageString_21x20(82, 100 + 38 * 6, DJXTZT, WHITE, BLACK); //电机系统状态
        
        //LCD_DrawImageString_21x20(82, 100 + 38 * 7, DJLife, WHITE, BLACK); //电机Life

       
        
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 0, ymtb, WHITE, BLACK); //油门踏板
        LCD_DrawImage1BPP_11x20(400 + 320 - 24, 100 + 38 * 0, BMP_ASIC_11x20[37 - 32], WHITE, BLACK); //%
        
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 1, zdtb, WHITE, BLACK); //制动踏板
        LCD_DrawImage1BPP_11x20(400 + 320 - 24, 100 + 38 * 1, BMP_ASIC_11x20[37 - 32], WHITE, BLACK); //% 
        
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 2, chesu, WHITE, BLACK); //车速
        LCD_DrawImageString_21x20(400 + 320 - 24 - 24, 100 + 38 * 2, km1h, WHITE, BLACK); //km/h 

        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 3, zcgzdm, WHITE, BLACK); //整车故障代码

        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 4, sczt, WHITE, BLACK); //锁车状态

        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 5, xhlc, WHITE, BLACK); //续驶里程
        LCD_DrawImage1BPP(400 + 320 - 24 - 11, 100 + 38 * 5, BMP_HZ_KM, WHITE, BLACK); //KM

        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 6, gzgl, WHITE, BLACK); //工作功率
        LCD_DrawImageString_21x20(400 + 320 - 24 - 11, 100 + 38 * 6, char_kwh, WHITE, BLACK); //KWH 
...
void MOTOUpdate(unsigned char index) {
    if (index == 1) {
        print_SZ_1(82 + 200 + 16, 100 - 8 + 38 * 0, CAN_0x08029F80.Voltage, 3, 0, WHITE);
        updata_DAT(82 + 200 + 16, 100 - 8 + 38 * 1, CAN_0x08029F80.Current, 0.1, 500, WHITE, 3, 0);
        updata_DAT(82 + 200 + 16, 100 - 8 + 38 * 2, CAN_0x08029F80.DriveMotorTemp, 1, 40, WHITE, 3, 0);
        updata_DAT(82 + 200 + 16, 100 - 8 + 38 * 3, CAN_0x08029F80.MotorCtrlTemp, 1, 40, WHITE, 3, 0);
        //print_SZ_1(82 + 200 - 32, 100 - 8 + 38 * 4, CAN_0x08019F80.VCU_FaultCode, 6, 0, WHITE);
        ...
        print_SZ_1(82 + 200 + 320 + 16, 100 - 8 + 38 * 0, CAN_0x08039F80.AcceleratePedalAperture, 3, 0, WHITE);
        print_SZ_1(82 + 200 + 320 + 16, 100 - 8 + 38 * 1, CAN_0x08039F80.BrakePedalAperture, 3, 0, WHITE);
        print_SZ_1(82 + 200 + 320 + 16, 100 - 8 + 38 * 2, SPEED, 3, 0, WHITE);
        print_SZ_1(82 + 200 + 320 - 32, 100 - 8 + 38 * 3, CAN_0x08019F80.VCU_FaultCode, 6, 0, WHITE);
        if (CAN_0x08039F80.VehicleLockingStatus == 2) {
            LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 4, yisuo, GREEN, BLACK);
        } else if (CAN_0x08039F80.VehicleLockingStatus == 1) {
            LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 4, weisuo, GREEN, BLACK);
        }
        print_SZ_1(82 + 200 + 320, 100 - 8 + 38 * 5, CAN_0x08039F80.DriveMileage * 0.1, 4, 0, WHITE);
        updata_DAT(82 + 200 + 320 + 16, 100 - 8 + 38 * 6, CAN_0x08039F80.RunningPower, 0.1, 300, WHITE, 3, 0);
    } else if (index == 2) {
...
void DCDCFrame(void) {
    ...
    LCD_DrawImageString_21x20(82, 100, srdy, WHITE, BLACK); //输入电压
    LCD_DrawImage1BPP_11x20(400 - 24, 100, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V

    LCD_DrawImageString_21x20(82, 100 + 38, srdl, WHITE, BLACK); //输入电流
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //A

    LCD_DrawImageString_21x20(82, 100 + 38 * 2, scdy, WHITE, BLACK); //输出电压
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 2, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V

    LCD_DrawImageString_21x20(82, 100 + 38 * 3, scdl, WHITE, BLACK); //输出电流
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 3, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //A

    LCD_DrawImageString_21x20(82, 100 + 38 * 4, dcdclife, WHITE, BLACK); //DCDCLife


    LCD_DrawImageString_21x20(82 + 320, 100, kzqwd, WHITE, BLACK); //控制器温度
    LCD_DrawImage1BPP(720 - 24, 100, BMP_T, WHITE, BLACK); //℃

    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 1, kzqyczt, WHITE, BLACK); //控制器预充状态

    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 2, dcdczt, WHITE, BLACK); //DCDC状态

    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 3, gzdm, WHITE, BLACK); //故障代码
}
...
void DCDCUpdate(void) {
    ...
    print_SZ_1(82 + 200 + 20, 100 - 8 + 38 * 2, CAN_0x142CFF98.DCDC_OutputAssistLowVoltage, 3, 0, WHITE);
    print_SZ_1(82 + 200 + 20, 100 - 8 + 38 * 3, CAN_0x142CFF98.DCDC_OutputCurrent, 3, 0, WHITE);
    print_SZ_1(82 + 200 + 20, 100 - 8 + 38 * 4, CAN_0x142CFF98.DCDC_Life, 3, 0, WHITE);

    
    updata_DAT(82 + 200 + 300, 100 - 8, CAN_0x142CFF98.DCDC_CtrlTemp, 1, 40, WHITE, 3, 0);
    if (CAN_0x142CFF98.DCDC_CtrlPrechargeStatus == 1) {
        LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 1, ywc, GREEN, BLACK);
    } else if (CAN_0x142CFF98.DCDC_CtrlPrechargeStatus == 0) {
        LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 1, wwc, GREEN, BLACK);
    }
...
//        LCD_DrawImage1BPP(82 + 320 + 42 * 6 - 5, 100 + 38 * 2, BMP_Guzhang, RED, BLACK);
    }
    print_D(82 + 200 + 300, 100 - 8 + 38 * 3, CAN_0x142CFF98.DCDC_FaultCode, 4, 0, WHITE);
}
...
void DMQFrame(void) {
    ...
    LCD_DrawImageString_21x20(82, 100, djzs, WHITE, BLACK); //电机转速
    LCD_DrawImageString_21x20(400 - 24 - 11 - 11, 100, char_rpm, WHITE, BLACK); //

    LCD_DrawImageString_21x20(82, 100 + 38 * 1, srdy, WHITE, BLACK); //输入电压
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 1, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V

    LCD_DrawImageString_21x20(82, 100 + 38 * 2, srdl, WHITE, BLACK); //输入电流
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 2, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //A

    LCD_DrawImageString_21x20(82, 100 + 38 * 3, qblife, WHITE, BLACK); //气泵Life
    ...
    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 2, qbzt, WHITE, BLACK); //气泵状态
...
void DMQUpdate(void) {
    ...
    print_SZ_1(82 + 200 + 20, 100 - 8 + 38 * 3, CAN_0x1429FF9B.DCAC_Life, 3, 0, WHITE);

    
    updata_DAT(82 + 200 + 300, 100 - 8, CAN_0x1429FF9B.DCAC_CtrlTemp, 1, 40, WHITE, 3, 0);
    if (CAN_0x1429FF9B.DCAC_CtrlPrechargeStatus == 1) {
        LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 1, ywc, GREEN, BLACK);
    } else if (CAN_0x1429FF9B.DCAC_CtrlPrechargeStatus == 0) {
        LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 1, wwc, GREEN, BLACK);
    }
...
//        LCD_DrawImage1BPP(82 + 320 + 42 * 6 - 5, 100 + 38 * 2, BMP_Guzhang, RED, BLACK);
    ...
    print_D(82 + 200 + 300, 100 - 8 + 38 * 3, CAN_0x1429FF9B.DCAC_FaultCode, 4, 0, WHITE);   
}
...
void DMYFrame(void) {
    ...
    LCD_DrawImageString_21x20(82, 100 + 38 * 3, yblife, WHITE, BLACK); //油泵Life
    ...
    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 2, ybzt, WHITE, BLACK); //油泵状态
...
void BMSFrame(unsigned char index) {
    ...
    if (index == 1) {
    LCD_DrawImageString_21x20(82, 100, dczzdy, WHITE, BLACK); //电池组总电压    
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 0, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 1, dczzdl, WHITE, BLACK); //电池组总电流    
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 1, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //A
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 2, gyjcqzt, WHITE, BLACK); //高压接触器状态  
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 3, zdyxfddl, WHITE, BLACK); //最大允许放电电流 
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 3, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //A
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 4, zdyxcddl, WHITE, BLACK); //最大允许充电电流 
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 4, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //A
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 5, dczyxzgwd, WHITE, BLACK); //电池组允许最高温度 
    LCD_DrawImage1BPP(400 - 24, 100 + 38 * 5, BMP_T, WHITE, BLACK); //℃
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 6, dczyxzdwd, WHITE, BLACK); //电池组允许最低温度
    LCD_DrawImage1BPP(400 - 24, 100 + 38 * 6, BMP_T, WHITE, BLACK); //℃
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 7, dczyxzdsoc, WHITE, BLACK); //电池组允许最低SOC
    LCD_DrawImage1BPP_11x20(400 - 24, 100 + 38 * 7, BMP_ASIC_11x20[37 - 32], WHITE, BLACK); //%
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 8, pjwd, WHITE, BLACK); //平均温度
    LCD_DrawImage1BPP(400 - 24, 100 + 38 * 8, BMP_T, WHITE, BLACK); //℃
    
    LCD_DrawImageString_21x20(82, 100 + 38 * 9, jydz, WHITE, BLACK); //绝缘电阻  
    LCD_DrawImage1BPP(400 - 24, 100 + 38 * 9, BMP_Omu, WHITE, BLACK); 
    
    /*LCD_DrawImageString_21x20(82, 100 + 38 * 9, ZLCDQZJWD, WHITE, BLACK); //直流充电枪正极温度   
    LCD_DrawImage1BPP(400 - 24, 100 + 38 * 9, BMP_T, WHITE, BLACK); //℃*/
          
    
    /*LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 1, DCXTNZ, WHITE, BLACK); //电池系统内阻 
    LCD_DrawImage1BPP(400 + 320 - 24, 100 + 38 * 1, BMP_Omu, WHITE, BLACK);*/ 
    
    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 0, zgdy, WHITE, BLACK); //
    LCD_DrawImage1BPP_11x20(720 - 24 - 63, 100 + 38 * 0, BMP_ASIC_11x20[86 - 32], WHITE, BLACK); //V
    
    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 1, zddy, WHITE, BLACK); //
    LCD_DrawImage1BPP_11x20(720 - 24 - 63, 100 + 38 * 1, BMP_ASIC_11x20[65 - 32], WHITE, BLACK); //V
    
    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 2, zgwd, WHITE, BLACK); //
    LCD_DrawImage1BPP(720 - 28 - 63, 100 + 38 * 2, BMP_T, WHITE, BLACK); //℃
    
    LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 3, zdwd, WHITE, BLACK); //
        ...
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 4, dczt, WHITE, BLACK); //电池状态
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 5, cfdms, WHITE, BLACK); //充放电模式
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 6, dtdcsl, WHITE, BLACK); //单体电池总数
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 7, cdcnwdsl, WHITE, BLACK); //充电储能温度数量
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 8, cdcnxtsl, WHITE, BLACK); //充电储能子系统数量
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 9, cdcnxth, WHITE, BLACK); //充电储能子系统号

    } else if (index == 2) {
        /*LCD_DrawImageString_21x20(82, 100 + 38 * 1, CDCNXTSL, WHITE, BLACK); //充电储能子系统数量
        LCD_DrawImageString_21x20(82, 100 + 38 * 2, CDCNXTH, WHITE, BLACK); //充电储能子系统号
        LCD_DrawImageString_21x20(82, 100 + 38 * 3, DTDCSL, WHITE, BLACK); //单体电池总数
        LCD_DrawImageString_21x20(82, 100 + 38 * 4, CDCNWDSL, WHITE, BLACK); //充电储能温度数量
        LCD_DrawImageString_21x20(82, 100 + 38 * 5, CDCNXTGZSL, WHITE, BLACK); //充电储能系统故障数量
        
                
        LCD_DrawImageString_21x20(82 + 320, 100, ZZJCQZT, WHITE, BLACK); //总正接触器状态          
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 1, ZFJCQZT, WHITE, BLACK); //总负接触器状态
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 2, YCJCQZT, WHITE, BLACK); //预充接触器状态
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 3, CDJCQZT, WHITE, BLACK); //充电接触器状态
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 4, DCJRXTGZZT, WHITE, BLACK); //电池加热系统工作状态
        LCD_DrawImageString_21x20(82 + 320, 100 + 38 * 5, DCLQXTGZZT, WHITE, BLACK); //电池冷却系统工作状态
        */
    } else if (index == 3) {
...
void BMSUpdate(unsigned char index) {
    if (index == 1) {
#if 1
        print_SZ_1(82 + 200 + 30, 100 - 8, CAN_0x10F8159E.BMS_Voltage * 0.1, 3, 0, WHITE);
        updata_DAT(82 + 200 + 30 - 16, 100 - 8 + 38 * 1, CAN_0x10F8159E.BMS_Current, 0.05, 1600, WHITE, 4, 0);
        if (CAN_0x10F8159E.High_Voltage_RelayStatus == 1) {
            LCD_DrawImageString_21x20(82 + 42 * 6 - 5, 100 + 38 * 2, bihe, GREEN, BLACK);
        } else if (CAN_0x10F8159E.High_Voltage_RelayStatus == 0) {
            LCD_DrawImageString_21x20(82 + 42 * 6 - 5, 100 + 38 * 2, duankai, YELLOW, BLACK);
        }
        updata_DAT(82 + 200 + 30 - 16, 100 - 8 + 38 * 3, CAN_0x10F8169E.BMS_AllowMAXDischargeCurrent, 0.05, 1600, WHITE, 4, 0);
        updata_DAT(82 + 200 + 30 - 16, 100 - 8 + 38 * 4, CAN_0x10F8169E.BMS_AllowMAXRecycleCurrent, 0.05, 1600, WHITE, 4, 0);
        updata_DAT(82 + 200 + 30, 100 - 8 + 38 * 5, CAN_0x10F8169E.BMS_AllowMAXTemp, 1, 40, WHITE, 3, 0);
        updata_DAT(82 + 200 + 30, 100 - 8 + 38 * 6, CAN_0x10F8169E.BMS_AllowMINTemp, 1, 40, WHITE, 3, 0);
        print_SZ_1(82 + 200 + 30 - 48, 100 - 8 + 38 * 7, CAN_0x10F8169E.BMS_AllowMINSOC, 6, 0, WHITE);
        updata_DAT(82 + 200 + 30, 100 - 8 + 38 * 8, CAN_0x10F8159E.BMS_Average_Temp, 1, 40, WHITE, 3, 0);
        print_SZ_1(82 + 200 + 30 - 48, 100 - 8 + 38 * 9, CAN_0x18F8199E.InsulationResistance , 6, 0, WHITE);

        
        
        print_SZ_1(82 + 200 + 260, 100 - 8 + 38 * 0, CAN_0x18F81A9E.BMS_MAX_Cell_Voltage, 4, 3, WHITE); //电池最高电压
        print_SZ_1(82 + 200 + 260 + 16 * 7, 100 - 8 + 38 * 0, CAN_0x18F81A9E.BMS_MAX_Cell_Voltage_CaseNum, 2, 0, WHITE);
        print_SZ_1(82 + 200 + 260 + 16 * 11, 100 - 8 + 38 * 0, CAN_0x18F81A9E.BMS_MAX_Cell_Voltage_Num, 2, 0, WHITE);

        print_SZ_1(82 + 200 + 260, 100 - 8 + 38 * 1, CAN_0x18F81A9E.BMS_MIN_Cell_Voltage, 4, 3, WHITE); //电池最高电压
        print_SZ_1(82 + 200 + 260 + 16 * 7, 100 - 8 + 38 * 1, CAN_0x18F81A9E.BMS_MIN_Cell_Voltage_CaseNum, 2, 0, WHITE);
        print_SZ_1(82 + 200 + 260 + 16 * 11, 100 - 8 + 38 * 1, CAN_0x18F81A9E.BMS_MIN_Cell_Voltage_Num, 2, 0, WHITE);

        updata_DAT(82 + 200 + 260 + 16 * 2, 100 - 8 + 38 * 2, CAN_0x18F8179E.BMS_MAX_Temp, 1, 40, WHITE, 3, 0); //最高温度 
        print_SZ_1(82 + 200 + 260 + 16 * 7, 100 - 8 + 38 * 2, CAN_0x18F8179E.BMS_MAX_Temp_CaseNum, 2, 0, WHITE);
        print_SZ_1(82 + 200 + 260 + 16 * 11, 100 - 8 + 38 * 2, CAN_0x18F8179E.BMS_MAX_Temp_CellNum, 2, 0, WHITE);

        updata_DAT(82 + 200 + 260 + 16 * 2, 100 - 8 + 38 * 3, CAN_0x18F8179E.BMS_MIN_Temp, 1, 40, WHITE, 3, 0); //最低温度 
        print_SZ_1(82 + 200 + 260 + 16 * 7, 100 - 8 + 38 * 3, CAN_0x18F8179E.BMS_MIN_Temp_CaseNum, 2, 0, WHITE);
        print_SZ_1(82 + 200 + 260 + 16 * 11, 100 - 8 + 38 * 3, CAN_0x18F8179E.BMS_MIN_Temp_CellNum, 2, 0, WHITE);
        
        if (CAN_0x10F8159E.BMS_BasicStatus == 1) {
            LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 4, guzhang, RED, BLACK);
        } else if (CAN_0x10F8159E.High_Voltage_RelayStatus == 0) {
            LCD_DrawImageString_21x20(82 + 320 + 42 * 6 - 5, 100 + 38 * 4, zhengchang, GREEN, BLACK);
        }
        
        print_SZ_1(82 + 200 + 260 + 16 * 7, 100 - 8 + 38 * 5, CAN_0x10F8159E.BMS_ChargingModel, 2, 0, WHITE);
        
        print_SZ_1(82 + 200 + 260 + 16 * 6, 100 - 8 + 38 * 6, CAN_0x18F8199E.StoredEnergyCellVoltageNUM, 3, 0, WHITE);
        
        print_SZ_1(82 + 200 + 260 + 16 * 6, 100 - 8 + 38 * 7, CAN_0x18F8199E.StoredEnergyCellTempNUM, 3, 0, WHITE);
        
        print_SZ_1(82 + 200 + 260 + 16 * 6, 100 - 8 + 38 * 8, CAN_0x18F8199E.StoredEnergySYSNUM, 3, 0, WHITE);
        
        print_SZ_1(82 + 200 + 260 + 16 * 6, 100 - 8 + 38 * 9, CAN_0x18F8199E.StoredEnergySYSNum, 3, 0, WHITE);
...
void BATUpdate(unsigned char index) {
    ...
    if (index == 5) {
        for (j = 0; j < 5; j++) {
            for (i = 0; i < 10; i++) {
                if (BAT_Cell_Temp[j * 10 + i] == 0)
                    updata_DAT(60 + 23 + 42 + j * 160 - 40, 46 + 70 + 36 * i, BAT_Cell_Temp[j * 10 + i], 1, 40, RED, 3, 0); //单体温度
                else updata_DAT(60 + 23 + 42 + j * 160 - 40, 46 + 70 + 36 * i, BAT_Cell_Temp[j * 10 + i], 1, 40, GREEN, 3, 0); //单体温度
            }
        }
    }*/
...
void frm_speed(void) {
    if (f_index == 0) {
        ...
        LCD_DrawImageString_21x20(340 - 40, 145, sb, YELLOW, BLACK); //
...
void disp_system(unsigned char id) {
    ...
    LCD_DrawImageString_21x20(336 + 24, 240, tc, color, BLACK); //退出 
}
