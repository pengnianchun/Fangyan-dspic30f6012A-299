...
unsigned int e_limit_pSpeed=limit_pSpeed;
...
//限速EEROM备份
unsigned int _EEDATA(2) EE_limit_pSpeed_1 = limit_pSpeed;
unsigned int _EEDATA(2) EE_limit_pSpeed_2 = limit_pSpeed;
unsigned int _EEDATA(2) EE_limit_pSpeed_3 = limit_pSpeed;
...
void EEROM_WriteXSpeed(void) {
    EEROM_WriteWord(__builtin_tbladdress(&EE_limit_pSpeed_1), e_limit_pSpeed);
    EEROM_WriteWord(__builtin_tbladdress(&EE_limit_pSpeed_2), e_limit_pSpeed);
    EEROM_WriteWord(__builtin_tbladdress(&EE_limit_pSpeed_3), e_limit_pSpeed);
}

void EEROM_ReadXSpeed(void) {
    unsigned int dump[3] = {0, 0, 0};
    dump[0] = EEROM_ReadWord(__builtin_tbladdress(&EE_limit_pSpeed_1));
    dump[1] = EEROM_ReadWord(__builtin_tbladdress(&EE_limit_pSpeed_1));
    dump[2] = EEROM_ReadWord(__builtin_tbladdress(&EE_limit_pSpeed_1));

    if (dump[0] == dump[1]) e_limit_pSpeed = dump[0];
    else if (dump[1] == dump[2]) e_limit_pSpeed = dump[1];
    else if (dump[2] == dump[1]) e_limit_pSpeed = dump[2];
    else e_limit_pSpeed = limit_pSpeed;
}
