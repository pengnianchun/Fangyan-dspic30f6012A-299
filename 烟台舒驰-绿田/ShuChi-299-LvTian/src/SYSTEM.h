...
//百米脉冲数  275/70R22.5  轮胎尺寸465 主减速比6.14
#define  HM_PLUSE      193
//背光亮度值
...
//软件版本定义
#define  Version      100       //精度0.1  如V1.0
#define  Version_date 20170816

#define  VIDEO        1         //0不带视频  1带视频

#define  limit_pSpeed    99     //限速99
...
extern unsigned int e_limit_pSpeed;
...
void EEROM_WriteXSpeed(void);
void EEROM_ReadXSpeed(void);

extern unsigned int  single_miles;
extern unsigned long total_miles;
extern unsigned int  X_pSpeed;
...
#define  M_flag           gKEY[4].bit6
#define  K_ON             gKEY[4].bit7
...
extern  unsigned char  VCU_Status[10];
extern  unsigned long  VCU_fault;//系统故障码
extern  unsigned char  VCU_Cmd[5];//控制指令
extern  unsigned char  MCU_Num[5];//驱动电机序号
extern  unsigned char  MCU_Status[10];//驱动电机状态
extern  unsigned long  MCU_fault;//系统故障码

extern  unsigned char  QB_Status[5];
extern  unsigned int   QB_Power;//电机功率
extern  unsigned char  QB_temperature;//电机温度
extern  unsigned char  QB_controler_temperature;//电机控制器温度
extern  unsigned int   QB_controler_voltage;//母线电压
extern  unsigned int   QB_speed;//转速

extern  unsigned char  YB_Status[5];
extern  unsigned int   YB_Power;//电机功率
extern  unsigned char  YB_temperature;//电机温度
extern  unsigned char  YB_controler_temperature;//电机控制器温度
extern  unsigned int   YB_controler_voltage;//母线电压
extern  unsigned int   YB_speed;//转速

extern  unsigned char  DCDC_Status[5];//工作状态
extern  unsigned int   DCDC_MX_voltage;//母线电压

extern  unsigned int   JY_R;//绝缘电阻
extern  unsigned char  JY_Status[5]; //正极绝缘报警  负极绝缘报警
extern  unsigned int   CD_voltage;   //电池组最大充电电压
extern  unsigned char  Vmax_xt_num;  //最高电压电池子系统号
extern  unsigned char  Vmin_xt_num;  //最低电压电池子系统号   
extern  unsigned char  DC_fault_dj;  //BMS 故障等级

extern  unsigned char  Tpj; //子系统平均温度
extern  unsigned char  Tmax_xt_num;//最高温度子系统号
extern  unsigned char  Tmin_xt_num;//最低温度子系统号               
extern  unsigned char  Tmax_tz_num;//最高温度探针序号          
extern  unsigned char  Tmin_tz_num;//最低温度探针序号  
extern  unsigned char  DC_cd_sum;//可充电储能装置故障总数 N1
extern  unsigned long  DC_fault;//系统故障码
extern  unsigned int   MAX_cd_voltage; //最高充电电压
extern  unsigned char  DC_control;//控制
extern  unsigned char  BAT_sum;//单体数 
extern  unsigned int   BAT_Vmax_bj; //单体电压报警上限
extern  unsigned int   BAT_Vmax_qd; //单体电压切断上限
extern  unsigned int   BAT_Vmin_bj; //单体电压报警下限
extern  unsigned int   BAT_Vmin_qd; //单体电压切断下限
extern  unsigned int   DC_Max_ed_cd_current; //额定最大充电电流
extern  unsigned int   DC_Max_ed_fd_current; //额定最大放电电流           
