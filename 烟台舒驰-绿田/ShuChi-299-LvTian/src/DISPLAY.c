...
*/
void disp_rectange1(unsigned int x, unsigned int y, //画方框
        unsigned int w,
        unsigned char wdat,
        unsigned int h,
        unsigned char hdat,
...
void BMP_Men_Guan(unsigned int x, unsigned int y, unsigned char color) {
    //门外框
    disp_rectange1(x, y, 72, 2, 88, 2, color);
    ...
    disp_rectange1(x + 4, y + 3, 30, 2, 78, 2, color);
    ...
    disp_rectange1(x + 4 + 35, y + 3, 29, 2, 78, 2, color);
}
...
void BMP_Men_Kai(unsigned int x, unsigned int y, unsigned char color) {
    ...
    //门左内框
    disp_rectange1(x + 4, y + 3, 30, 2, 78, 2, BLACK);
    ...
    disp_rectange1(x + 4 + 35, y + 3, 29, 2, 78, 2, BLACK);
}
...
void BMP_BUS(unsigned int x, unsigned int y) {
    ...
    disp_rectange1(x + 209, y, 178, 2, 10, 2, WHITE);
    ...
    //小窗户1
    disp_rectange1(x + 8 + 3, y + 8 + 12 + 3, 31, 1, 20, 1, WHITE);
    ...
    //小窗户2
    disp_rectange1(x + 8 + 3 + 34, y + 8 + 12 + 3, 31, 1, 20, 1, WHITE);
    ...
    //中窗户1
    disp_rectange1(x + 8 + 3 + 34 + 34, y + 8 + 12 + 3, 53, 1, 46, 1, WHITE);
    ...
    //中窗户2
    disp_rectange1(x + 8 + 3 + 34 + 34 + 56, y + 8 + 12 + 3, 53, 1, 46, 1, WHITE);
    ...
    //前窗户1
    disp_rectange1(x + 8 + 3 + 34 + 34 + 56 * 2 + 72 + 10, y + 8 + 12 + 3, 53, 1, 46, 1, WHITE);
    ...
    //前窗户
    disp_rectange1(x + 8 + 3 + 34 + 34 + 56 * 3 + 72 + 20, y + 8 + 12 + 3, 53, 1, 46, 1, WHITE);
}
...
*/
    ...
    LCD_DrawImage1BPP(180, 150, Bmp_SOC, WHITE, BLACK); //SOC

    disp_rectange1(225, 150 + 5 - 10, 335, 2, 32, 2, WHITE);
    for (i = 0; i < 3; i++)
    ...
    LCD_DrawImage1BPP(650, 155, Bmp_bfh, WHITE, BLACK);

    LCD_DrawImage1BPP(10, 365 + 15 - 50 + 10, Bmp_LCheng, YELLOW, BLACK); //里程
    LCD_DrawImage1BPP(125, 318 + 15 + 33 + 8, Bmp_Km, WHITE, BLACK); //单位 Km
    LCD_DrawImage1BPP(125, 318 + 15 + 33 * 2 + 8, Bmp_Km, WHITE, BLACK); //单位 Km

    LCD_DrawImage1BPP(165, 365 + 15 - 50 + 10, Bmp_Gao, YELLOW, BLACK); //高压电池
    LCD_DrawImage1BPP(165+20, 365 + 15 - 50 + 10, Bmp_Ya, YELLOW, BLACK);
    LCD_DrawImage1BPP(165 + 42, 365 + 15 - 50 + 10, Bmp_dc, YELLOW, BLACK);
    LCD_DrawImage1BPP(265, 318 + 15 + 33 + 8, Bmp_V, WHITE, BLACK); //V
    LCD_DrawImage1BPP(265, 318 + 15 + 33 * 2 + 8, Bmp_A, WHITE, BLACK); //A

    LCD_DrawImage1BPP(295, 365 + 15 - 50 + 10, Bmp_dt, YELLOW, BLACK); //单体电压
    LCD_DrawImage1BPP(295 + 42, 365 + 15 - 50 + 10, Bmp_DY, YELLOW, BLACK);
    LCD_DrawImage1BPP(395-5, 318 + 15 + 33 + 8, Bmp_V, WHITE, BLACK); //V
    LCD_DrawImage1BPP(395-5, 318 + 15 + 33 * 2 + 8, Bmp_V, WHITE, BLACK); //V

    LCD_DrawImage1BPP(420, 365 + 15 - 50 + 10, Bmp_dt, YELLOW, BLACK); //单体温度
    LCD_DrawImage1BPP(420 + 42, 365 + 15 - 50 + 10, Bmp_wd, YELLOW, BLACK);
    LCD_DrawImage1BPP(420 + 90, 365 + 15 - 50 + 10 + 33, Bmp_deg, WHITE, BLACK); //℃
    LCD_DrawImage1BPP(420 + 90, 365 + 15 - 50 + 10 + 33 * 2, Bmp_deg, WHITE, BLACK); //℃
    ...
    LCD_DrawImage1BPP(640, 365 + 15 - 50 + 10 + 33, Bmp_deg, WHITE, BLACK); //℃
    LCD_DrawImage1BPP(640, 365 + 15 - 50 + 10 + 33 * 2, Bmp_deg, WHITE, BLACK); //℃

    LCD_DrawImage1BPP(670, 365 + 15 - 50 + 10, Bmp_dj, YELLOW, BLACK); //电机
    LCD_DrawImage1BPP(670 + 42, 365 + 15 - 50 + 10, Bmp_zj, YELLOW, BLACK); //转矩
    LCD_DrawImage1BPP(670 + 100-3, 365 + 15 - 50 + 10 + 33, Bmp_Nm, WHITE, BLACK); //NM

    disp_rectange1(5, 365 + 15 - 50+2, 150, 1, 100, 1, GREEN);
    disp_rectange1(5 + 140 + 15, 365 + 15 - 50+2, 125, 1, 100, 1, GREEN);
    disp_rectange1(5 + 270 + 15, 365 + 15 - 50+2, 125 - 5, 1, 100, 1, GREEN);
    disp_rectange1(5 + 400 + 10, 365 + 15 - 50+2, 125 - 5, 1, 100, 1, GREEN);
    disp_rectange1(5 + 530 + 5, 365 + 15 - 50+2, 125, 1, 100, 1, GREEN);
    disp_rectange1(5 + 660 + 5, 365 + 15 - 50+2, 130 - 5, 1, 100, 1, GREEN);
...
//总电压
    if(DC_voltage>=65534)DC_voltage=0;
    print_SZ_2(150 + 45, 365 + 15 - 50 + 10 + 33,DC_voltage/10,4,0,WHITE);
//总电流
    ...
    update_dl(150 + 45, 365 + 15 - 50 + 10 + 33*2,temp,3,j,WHITE);
//最高电压     
     if(Vmax>=0xFEFE)Vmax=0;
     print_SZ_2(305, 365 + 15 - 50 + 10 + 33,Vmax,4,3,WHITE);
//最低电压   
     if(Vmin>=0xFEFE)Vmin=0;
     print_SZ_2(305, 365 + 15 - 50 + 10 + 33*2,Vmin,4,3,WHITE); 
//电池最高温度 
    if(Tmax>=254)Tmax=40;
    update_deg(410 + 50-20, 365 + 15 - 50 + 10 + 33,Tmax,WHITE);
//电池最低温度 
    if(Tmin>=254)Tmin=40;
    update_deg(410 + 50-20, 365 + 15 - 50 + 10 + 33*2,Tmin,WHITE);    
//电机温度 
    if(DJ_temperature>=254)DJ_temperature=40;
    update_deg(540 + 50-20, 365 + 15 - 50 + 10 + 33,DJ_temperature,WHITE);  
//控制器温度 
    if(DJcontroler_temperature>=254)DJcontroler_temperature=40;
    update_deg(540 + 50-20, 365 + 15 - 50 + 10 + 33*2,DJcontroler_temperature,WHITE);
//驱动电机转矩 
    if(DJ_torque>=65534)temp=2000;else temp=DJ_torque/10;
    if(temp>=2000)temp=(temp-2000);
    else          temp=(2000-temp);     
  print_SZ_2(700, 365 + 15 - 50 + 10 + 33,temp,4,0,WHITE);
//门开关图像报警
    if (LED2) {
...
x=552-49-16;    
  //print_SZ_2(x, y, total_miles / 10, 7, 0, WHITE);
    print_SZ_2(10, 365 + 15 - 50 + 10 + 33, total_miles / 10, 7, 0, WHITE);
    print_SZ_2(10 + 16, 365 + 15 - 50 + 10 + 33 * 2, single_miles, 5, 1, WHITE);
}
...
//故障代码
  ...
  if((temp&0x03)==0x01)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(156-38,     y+4*35,Bmp_DLu,         color,BLACK);//短路过流 
  LCD_DrawImage1BPP(156-38+40,  y+4*35,Bmp_GLiu,        color,BLACK);//
    
  if((temp&0x04)==0x04)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(276-58,     y+4*35,Bmp_dj,       color,BLACK);//电机温度报警  
  LCD_DrawImage1BPP(276-58+40,  y+4*35,Bmp_wd,       color,BLACK);
  LCD_DrawImage1BPP(276-58+80,  y+4*35,Bmp_bj,       color,BLACK);
  
  if((temp&0x08)==0x08)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(418-59,     y+4*35,Bmp_kzq,      color,BLACK);//控制器温度报警
  LCD_DrawImage1BPP(418-59+56,  y+4*35,Bmp_wd,       color,BLACK);
  LCD_DrawImage1BPP(418-59+96,  y+4*35,Bmp_bj,       color,BLACK);
  
  if((temp&0x10)==0x10)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(541-38+14,     y+4*35,Bmp_TXun,     color,BLACK);//通讯故障
  LCD_DrawImage1BPP(541-38+40+14,  y+4*35,Bmp_ST[0],    color,BLACK);
  
  if((temp&0x20)==0x20)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(673-68+14,     y+4*35,Bmp_ZZCGQi,   color,BLACK);//转子传感器故障
  LCD_DrawImage1BPP(673-68+96+14,  y+4*35,Bmp_ST[0],    color,BLACK);
...
//故障代码
   ...
   //} 
  if((temp&0x03)==0x01)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(156-38,     y+9*35,Bmp_DLu,         color,BLACK);//短路过流 
  LCD_DrawImage1BPP(156-38+40,  y+9*35,Bmp_GLiu,        color,BLACK);//
 
  if((temp&0x04)==0x04)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(276-58,     y+9*35,Bmp_dj,       color,BLACK);//电机温度报警  
  LCD_DrawImage1BPP(276-58+40,  y+9*35,Bmp_wd,       color,BLACK);
  LCD_DrawImage1BPP(276-58+80,  y+9*35,Bmp_bj,       color,BLACK);
  
  if((temp&0x08)==0x08)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(418-59,     y+9*35,Bmp_kzq,      color,BLACK);//控制器温度报警
  LCD_DrawImage1BPP(418-59+56,  y+9*35,Bmp_wd,       color,BLACK);
  LCD_DrawImage1BPP(418-59+96,  y+9*35,Bmp_bj,       color,BLACK);
  
  if((temp&0x10)==0x10)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(541-38+14,     y+9*35,Bmp_TXun,     color,BLACK);//通讯故障
  LCD_DrawImage1BPP(541-38+40+14,  y+9*35,Bmp_ST[0],    color,BLACK);
  
  if((temp&0x20)==0x20)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(673-68+14,     y+9*35,Bmp_ZZCGQi,   color,BLACK);//转子传感器故障
  LCD_DrawImage1BPP(673-68+96+14,  y+9*35,Bmp_ST[0],    color,BLACK);
...
//}
  temp=DCDC_Status[0];
  if((temp&0x0c)==0x04)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(156-38,     y+4*35,Bmp_TXun,     color,BLACK);//通讯故障
  LCD_DrawImage1BPP(156-38+40,  y+4*35,Bmp_ST[0],    color,BLACK);
  
  temp=DCDC_Status[1];
  if((temp&0x01)==0x01)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(252-38,     y+4*35,Bmp_wd,       color,BLACK);//温度报警  
  LCD_DrawImage1BPP(252-38+40,  y+4*35,Bmp_bj,       color,BLACK);
  
  if((temp&0x02)==0x02)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(345-38,     y+4*35,Bmp_sc,       color,BLACK);//输出过流
  LCD_DrawImage1BPP(345-38+40,  y+4*35,Bmp_GLiu,     color,BLACK);
  
  if((temp&0x40)==0x40)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(438-38,     y+4*35,Bmp_sc,       color,BLACK);//输出短路
  LCD_DrawImage1BPP(438-38+40,  y+4*35,Bmp_DLu,      color,BLACK);
  
  if((temp&0x0c))color=RED;else color=GRAY;
     LCD_DrawImage1BPP(533-38,            y+4*35,Bmp_sc,       color,BLACK);//输出
     LCD_DrawImage1BPP(533-38+56,         y+4*35,Bmp_Ya,       color,BLACK); 
     if((temp&0x04)){
         LCD_DrawImage1BPP(533-38+40,     y+4*35,Bmp_Guo,      color,BLACK);//过压 
     }else if((temp&0x08)){
         LCD_DrawImage1BPP(533-38+40,     y+4*35,Bmp_Qian,     color,BLACK);//欠压
     }else
         LCD_DrawImage1BPP(533-38+40,     y+4*35,Bmp_Guo,      color,BLACK);//过压

     
  if((temp&0x30))color=RED;else color=GRAY;
     LCD_DrawImage1BPP(631-38,            y+4*35,Bmp_sr,       color,BLACK);//输入
     LCD_DrawImage1BPP(631-38+56,         y+4*35,Bmp_Ya,       color,BLACK); 
     if((temp&0x10)){
         LCD_DrawImage1BPP(631-38+40,     y+4*35,Bmp_Guo,      color,BLACK);//过压 
     }else if((temp&0x20)){
         LCD_DrawImage1BPP(631-38+40,     y+4*35,Bmp_Qian,     color,BLACK);//欠压
     }else
         LCD_DrawImage1BPP(631-38+40,     y+4*35,Bmp_Guo,      color,BLACK);//过压

  if((temp&0x80)==0x80)color=RED;else color=GRAY;
  LCD_DrawImage1BPP(730-38,     y+4*35,Bmp_YJian,   color,BLACK);//硬件故障
  LCD_DrawImage1BPP(730-38+40,  y+4*35,Bmp_ST[0],    color,BLACK);
