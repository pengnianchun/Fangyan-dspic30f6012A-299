...
void disp_BMP_baojing(void) {
    ...
    if (CAN_0x18EF4AEF.battle_jueyuan_warn == 1) color = RED;
    else color = GRAY;
    ...
    if (rKL7) color = YELLOW;
    else color = GRAY;
    if (color_old[6] != color) {
        color_old[6] = color;
        LCD_DrawImage1BPP(8 + 66 * 6, 10, Bmp_baojing[13], color, BLACK); //空滤
    }
    ...
    if (IN31 || IN32) color = GREEN;
    else color = GRAY;
    if (color_old[8] != color) {
        color_old[8] = color;
        //LCD_DrawImage1BPP(8 + 66 * 8, 10, Bmp_baojing[15], color, BLACK); //辅助气压
        LCD_DrawImage1BPP(8 + 66 * 8, 10, Bmp_baojing[20], color, BLACK); //除霜
    }
    ...
    if (color_old[9] != color) {
        color_old[9] = color;
        LCD_DrawImage1BPP(8 + 66 * 9, 10, Bmp_baojing[6], color, BLACK); //中门开状态
    }

    if (CAN_0x18EF4AEF.moto_t_warn == 1) color = RED;
    else color = GRAY;
    ...
    if (color_old[11] != color) {
        color_old[11] = color;
        LCD_DrawImage1BPP(8 + 66 * 11, 10, Bmp_baojing[12], color, BLACK); //小灯
    }
    /****************************第二行图片****************************************/
    if (CAN_0x18EF4BEF.Signal_charge == 1)
        color = RED;
    else if (CAN_0x18EF4BEF.Signal_charge == 2)
        color = YELLOW;
    else color = GRAY;
    if (color_old[12] != color) {
        color_old[12] = color;
        if (color == YELLOW)
            LCD_DrawImage1BPP(140 + 66 * 0, 74 - 5, Bmp_baojing[18], color, BLACK); //充电状态
        else
    ...
    if (IN26 || IN27) color = RED;
    else color = GRAY;
    if (color_old[14] != color) {
        color_old[14] = color;
        LCD_DrawImage1BPP(140 + 66 * 2, 74 - 5, Bmp_baojing[22], color, BLACK); //应急阀        
    }
    if (IN27)
        color = RED;
    else 
    ...
    if (CAN_0x18EF4AEF.moto_ready == 1) color = GREEN;
    else color = GRAY;
    ...
    if (color_old[18] != color) {
        color_old[18] = color;
        //LCD_DrawImage1BPP(140 + 66 * 6, 74 - 5, Bmp_baojing[17], color, BLACK); //中门应急阀
        LCD_DrawImage1BPP(140 + 66 * 6, 74 - 5, Bmp_baojing[21], color, BLACK); //暖风
    }

    if (CAN_18FECAEF.RedStopLampState == 1 || CAN_18FECA03.RedStopLampState == 1) 
        color = RED;
    else if (CAN_18FECAEF.AmberWarningLampStatus == 1 || CAN_18FECA03.AmberWarningLampStatus == 1) 
        color = YELLOW;
    else 
        color = GRAY;
...
void disp_FONT_baojing(unsigned int x, unsigned int y) {
    ...
    if (alarm_update_flag == 0) { //3S 更新一次 
        switch (al_index) {
            ...
            case 4:
                al_index = 5;
                if (CAN_0x18EF4AEF.moto_t_warn == 1) {
                    LCD_DrawImage1BPP(x, y + 8, BMP_DJ, YELLOW, BLACK); //电机高温报警
            ...
            case 5:
                al_index = 6;
                if (CAN_0x18EF4AEF.battle_t_warn == 1) {
            ...
            case 6:
                ...
                if (CAN_0x18EF4AEF.battle_higtv1_warn == 1) {
            ...
            case 7:
                ...
                if (CAN_0x18EF4AEF.battle_higtv2_warn == 1) {
            ...
            case 8:
                ...
                if (CAN_0x18EF4BEF.BMS_offline_warn == 1) {
                    LCD_DrawImageSBPP(x, y + 8, 42, DCLX, YELLOW, BLACK); //电池离线
            ...
            case 9:
                ...
                if (CAN_0x18EF4BEF.MCU_offline_warn == 1) {
                    LCD_DrawImageSBPP(x, y + 8, 42, DJLX, YELLOW, BLACK); //电机离线
                    LCD_DrawRect(x + 84, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            case 10:
                ...
                if (CAN_0x18EF4BEF.TCU_offline_warn == 1) {
                    LCD_DrawImageSBPP(x, y + 8, 63, BSXLX, YELLOW, BLACK); //变速箱离线
                    LCD_DrawRect(x + 105, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            case 11:
                al_index = 12;
                if (CAN_0x18EF4BEF.Engine_offline_warn == 1) {
                    LCD_DrawImageSBPP(x, y + 8, 63, FDJLX, YELLOW, BLACK); //发动机离线
                    LCD_DrawRect(x + 105, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            ...
            case 14:
                ...
                if (IN30) {
                    LCD_DrawImageSBPP(x, y + 8, 42, FZQYBJ, YELLOW, BLACK); //辅助气压报警
                    LCD_DrawRect(x + 42 + 42 + 42, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            ...
            case 20:
                al_index = 21;
                if (CAN_0x18EF4BEF.Signal_charge == 1 || CAN_0x18EF4BEF.Signal_charge == 2) {
            ...
            case 36:
                al_index = 37;
                if (CAN_0x18EF4AEF.battle_jueyuan_warn == 1) {
            ...
            case 38:
                ...
                for (i = 0; i < 5; i++) {
                    DM(i + 1, CAN_18FECAEF);
                    if (SPN >= 520281 && SPN <= 522000) {
                        break;
                    }
                }
                if (SPN >= 520281 && SPN <= 522000 && ((FMI & 0x07) == 1 || (FMI & 0x07) == 2)) {
                    LCD_DrawImageSBPP(x, y + 8, 42, DCGZ, YELLOW, BLACK); //电池故障
                    LCD_DrawRect(x + 42 + 42, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            ...
            case 40:
                ...
                for (i = 0; i < 5; i++) {
                    DM(i + 1, CAN_18FECAEF);
                    if (SPN >= 520200 && SPN <= 520280) {
                        break;
                    }
                }
                if (SPN >= 520200 && SPN <= 520280 && ((FMI & 0x07) == 1 || (FMI & 0x07) == 2)) {
            ...
            case 41:
                ...
                for (i = 0; i < 5; i++) {
                    DM(i + 1, CAN_18FECAEF);
                    if (SPN >= 2000 && SPN <= 2100) {
                        break;
                    }
                }
                if (SPN >= 2000 && SPN <= 2100 && ((FMI & 0x07) == 1 || (FMI & 0x07) == 2)) {
                    LCD_DrawImageSBPP(x, y + 8, 42, ZLZXGZ, YELLOW, BLACK); //助力转向故障
                    LCD_DrawRect(x + 42 + 42 + 42, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            ...
            case 44:
                ...
                for (i = 0; i < 5; i++) {
                    DM(i + 1, CAN_18FECAEF);
                    if ((SPN > 0 && SPN <= 1000) || (SPN >= 5600 && SPN <= 5900)) {
                        break;
                    }
                }
                if (((SPN > 0 && SPN <= 1000) || (SPN >= 5600 && SPN <= 5900)) && ((FMI & 0x07) == 1 || (FMI & 0x07) == 2)) {
                        LCD_DrawImageSBPP(x, y + 8, 11, HCUGZ, YELLOW, BLACK); //HCU故障
            ...
            case 45:
                ...
                //DM(1,CAN_18FECAEF);
                if ((CAN_18FECAEF.RedStopLampState == 1) || (CAN_18FECAEF.AmberWarningLampStatus == 1)) {
                    LCD_DrawImageSBPP(x, y + 8, 42, HHDLGZ, YELLOW, BLACK); //混合动力故障
                    LCD_DrawRect(x + 42 + 42 + 42, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            ...
            case 46:
                ...
                DM(1,CAN_18FECA03);
                if ((CAN_18FECA03.RedStopLampState == 1) 
                        || (CAN_18FECA03.AmberWarningLampStatus == 1)
                        || (SPN > 0)
                        )  {
...
void updata_Dangwei(unsigned int x, unsigned int y) {//0 : N;  1：D;  2 :R;  3：P
    ...
    gear = Current_Gear;
    if (gear == 125) gear = 0;
    else if (gear == 124) gear = 2;
    else if (gear >= 126 && gear <= 131) gear = 1;
    else gear = 0;
    if (gear == 1) {
        LCD_DrawImage1BPP(x - 10, y, BMP_DANGWEI[gear], GREEN, BLACK); //档位更新 
        LCD_DrawImage1BPP(x + 32 - 10, y + 15, BMP_SZ_1[Current_Gear - 125], GREEN, BLACK); //档位更新
        LCD_DrawRect(x + 32 - 10, y, 15, 15, BLACK);
    } else {
        LCD_DrawRect(x - 15, y, 15, 48, BLACK);
        LCD_DrawImage1BPP(x, y, BMP_DANGWEI[gear], GREEN, BLACK); //档位更新 
        LCD_DrawRect(x + 32, y, 15, 48, BLACK);
    }
}
...
void updata_SOC(unsigned int x, unsigned int y) {
    ...
    soc = CAN_0x18EF4BEF.BMS_SOC * 0.5;
...
void mainFrame(void) {
    ...
    /*LCD_DrawImage1BPP(175, 160 + 60 + 13 - 5, BMP_Current, WHITE, BLACK); //电流
    disp_rectange(225, 150 + 5 + 60 + 13 - 5, 335, 2, 32, 2 ,WHITE);
    LCD_DrawRect(225 + 83, 145 + 60 + 13 - 5, 2, 10, WHITE);
    LCD_DrawRect(225 + 83 + 83 + 83, 145 + 60 + 13 - 5, 2, 10, WHITE);   
    LCD_DrawRect(225 - 12, 155 - 14 + 60 + 7 + 13 - 5, 8, 2, WHITE); //-
    LCD_DrawImage1BPP(225 - 4, 155 - 14 + 60 + 13 - 5, BMP_SZ[5], WHITE, BLACK); //5
    LCD_DrawImage1BPP(225 + 4, 155 - 14 + 60 + 13 - 5, BMP_SZ[0], WHITE, BLACK); //0
    LCD_DrawImage1BPP(225 + 12, 155 - 14 + 60 + 13 - 5, BMP_SZ[0], WHITE, BLACK); //0

    LCD_DrawImage1BPP(225 + 83 + 83 - 4, 145 + 60 - 4 + 13 - 5, BMP_SZ[0], WHITE, BLACK); //0
    LCD_DrawRect(225 + 83 + 83, 155 + 60 + 13 - 5, 2, 32, WHITE);

    LCD_DrawImage1BPP(225 + 83 + 83 + 83 + 84 - 12, 155 - 14 + 60 + 13 - 5, BMP_SZ[5], WHITE, BLACK); //5
    LCD_DrawImage1BPP(225 + 83 + 83 + 83 + 84 - 4, 155 - 14 + 60 + 13 - 5, BMP_SZ[0], WHITE, BLACK); //0
    LCD_DrawImage1BPP(225 + 83 + 83 + 83 + 84 + 4, 155 - 14 + 60 + 13 - 5, BMP_SZ[0], WHITE, BLACK); //0
    LCD_DrawImage1BPP(660, 155 + 60 + 13 - 5, BMP_A, WHITE, BLACK);*/
    ...
    /*LCD_DrawImage1BPP(225 + 83 + 83 + 2, 260 + 8 + 36 * 3, BMP_Guzhang, WHITE, BLACK); //故障
    LCD_DrawImage1BPP(225 + 83 + 83 + 2 + 43, 260 + 8 + 36 * 3, BMP_Code, WHITE, BLACK); //代码*/
    ...
    //LCD_DrawRect(0, 430 + 10, 800, 2, GREEN); //底部横线 
}
...
void frmMain(void) {
    if (f_index == 0) { //只更新一次
        ...
        updata_DAT(480 + 40 - 10, 260 + 2 + 36 * 0, CAN_0x18EF4BEF.BMS_A, 8, 1000, WHITE, 4, 0); //电池电流
        //print_SZ_1(480 + 40, 260 + 3 + 36 * 2, CAN_0x18EF4BEF.CAP_voltage, 3, 0, WHITE); //电容电压   
        updata_DAT(480 + 40 - 10, 260 + 3 + 36 * 2, CAN_0x18EF4AEF.moto_speed, 20, 2000, WHITE, 4, 0); //电机转速 
    } else if (f_index == 2) {
        f_index = 3;
        disp_BMP_baojing();
        print_SZ_1(313 - 16 * 2, 260 + 2, CAN_0x18EF4CEF.Max_Cell_Voltage * 1.5, 4, 3, WHITE); //单体高电压
        print_SZ_1(313 - 16 * 2, 260 + 2 + 36 * 1, CAN_0x18EF4CEF.Min_Cell_Voltage * 1.5, 4, 3, WHITE); //单体低电压
    } else if (f_index == 3) {
        f_index = 4;
        disp_miles();
        ...
        updata_DAT(313, 260 + 2 + 36 * 2, CAN_0x18EF4AEF.Inverter_t, 1, 40, WHITE, 3, 0); //电机控制器温度
        updata_DAT(313, 260 + 2 + 36 * 3, CAN_0x18EF4DEF.Motor_Temperature, 1, 40, WHITE, 3, 0); //电机温度
    } else if (f_index == 5) {
        f_index = 6;
        ...
        f_index = 7;
        updata_DAT(480 + 40 + 6, 260 + 2 + 36 * 1, CAN_0x18EF4DEF.Max_Cell_Temperature, 0.2, 50, WHITE, 3, 0); //单体高温       
        disp_FONT_baojing(162, 260 + 1 + 36 * 4);
    } else if (f_index == 7) {
        f_index = 1;
        updata_Dangwei(138 + 17 + 66 * 4, 74 - 5);
        print_SZ_1(480 + 40 - 10, 260 + 3 + 36 * 3, fuel_rate * 0.05, 4, 0, WHITE);
...
void ICFrame(unsigned char index) { //仪表框架
    ...
    if (index == 1) {
        ...
        //IN2  暖风高档
        LCD_DrawImage1BPP(35, 75 + 25 * 1, BMP_Nuanfeng, WHITE, BLACK);
        LCD_DrawImage1BPP(35 + 42, 75 + 25 * 1, BMP_Gao, WHITE, BLACK);
        LCD_DrawImage1BPP(35 + 63, 75 + 25 * 1, BMP_Dang, WHITE, BLACK);
        //IN3  暖风低档
        LCD_DrawImage1BPP(35, 75 + 25 * 2, BMP_Nuanfeng, WHITE, BLACK);
        LCD_DrawImage1BPP(35 + 42, 75 + 25 * 2, BMP_Di, WHITE, BLACK);
        LCD_DrawImage1BPP(35 + 63, 75 + 25 * 2, BMP_Dang, WHITE, BLACK);
        //IN4  START档
        ...
        //IN6  近光灯
        LCD_DrawImageSBPP(35, 75 + 25 * 5, 21, JGDKG, WHITE, BLACK);
        //IN7  
        //IN8  前雾灯
        LCD_DrawImageSBPP(35, 75 + 25 * 7, 21, QWDKG, WHITE, BLACK);
        //IN9  后雾灯
        LCD_DrawImageSBPP(35, 75 + 25 * 8, 21, HWDKG, WHITE, BLACK);
        //IN10 
        //IN11 厢灯1开关
        LCD_DrawImageSBPP(35, 75 + 25 * 10, 21, XD1KG, WHITE, BLACK);
        //IN12 厢灯2开关
        LCD_DrawImageSBPP(35, 75 + 25 * 11, 21, XD2KG, WHITE, BLACK);
        //IN13
        //IN14 雨刮低档       
        for (i = 13; i < 16; i++) {
        ...
        //IN22 喇叭开关
        LCD_DrawImageSBPP(285, 75 + 25 * 5, 42, LBKG, WHITE, BLACK);
        //IN23 
        //IN24 远光灯
        LCD_DrawImageSBPP(285, 75 + 25 * 7, 21, YGDKG, WHITE, BLACK);
        //IN25 
        //IN26 中门应急阀报警
        LCD_DrawImage1BPP(285 , 75 + 25 * 9, BMP_Zhong, WHITE, BLACK);
        LCD_DrawImage1BPP(285  + 21, 75 + 25 * 9, BMP_Men, WHITE, BLACK);
        LCD_DrawImage1BPP(285  + 42, 75 + 25 * 9, BMP_Yingjifa, WHITE, BLACK);
        LCD_DrawImage1BPP(285  + 105, 75 + 25 * 9, BMP_Baojing, WHITE, BLACK);
        //IN27 前门应急阀报警
        LCD_DrawImage1BPP(285 , 75 + 25 * 10, BMP_IC_Qian, WHITE, BLACK);
        LCD_DrawImage1BPP(285  + 21, 75 + 25 * 10, BMP_Men, WHITE, BLACK);
        LCD_DrawImage1BPP(285  + 42, 75 + 25 * 10, BMP_Yingjifa, WHITE, BLACK);
        LCD_DrawImage1BPP(285  + 105, 75 + 25 * 10, BMP_Baojing, WHITE, BLACK);
        //IN28 前门关开关
        //LCD_DrawImageSBPP(285, 75 + 25 * 11, 21, QMGKG, WHITE, BLACK);
        //IN29 小灯开关
        LCD_DrawImageSBPP(285, 75 + 25 * 12, 21, XDKG, WHITE, BLACK);
        //IN30 辅助气压报警
        ...
        //OUT4  左近光灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 3, 21, ZJGDSC, WHITE, BLACK);
        //OUT5  左远光灯
        LCD_DrawImageSBPP(60, 75 + 25 * 4, 21, ZYGDSC, WHITE, BLACK);
        //OUT6  前雾灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 5, 21, QWDSC, WHITE, BLACK);
        //OUT7  左转向灯
        ...
        //OUT9  小灯
        LCD_DrawImageSBPP(60, 75 + 25 * 8, 21, XD, WHITE, BLACK);
        //OUT10 电源输出
        LCD_DrawImageSBPP(60, 75 + 25 * 9, 42, DYSC, WHITE, BLACK);
        //OUT11 右近光灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 10, 21, YJGDSC, WHITE, BLACK);
        //OUT12 前门灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 11, 21, QMDSC, WHITE, BLACK);
        //OUT13 启动请求
        LCD_DrawImageSBPP(60, 75 + 25 * 12, 42, QDQQ, WHITE, BLACK);
        //OUT14 风扇电源
        LCD_DrawImageSBPP(60, 75 + 25 * 13, 42, FSDY, WHITE, BLACK);
        //OUT15 右远光灯
        LCD_DrawImageSBPP(60, 75 + 25 * 14, 21, YYGDSC, WHITE, BLACK);
        //ADD
        ...
        //KL7  
        //KL8  散热器1开关
        //LCD_DrawImageSBPP(285 + 150, 75 + 25 * 7, 63, SRQ1KG, WHITE, BLACK);
        //KL9  
        ...
        //OUT1  
        //OUT2  位置灯
        LCD_DrawImageSBPP(60, 75 + 25 * 1, 21, WZD, WHITE, BLACK);
        //OUT3  中门灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 2, 42, ZMDSC, WHITE, BLACK);
        //OUT4  前路牌
        LCD_DrawImageSBPP(60, 75 + 25 * 3, 21, QLP, WHITE, BLACK);
        //OUT5  广告输出
        LCD_DrawImageSBPP(60, 75 + 25 * 4, 42, GGSC, WHITE, BLACK);
        //OUT6  后路牌
        LCD_DrawImageSBPP(60, 75 + 25 * 5, 21, HLP, WHITE, BLACK);
        //OUT7  TV1电源
        LCD_DrawImageSBPP(60, 75 + 25 * 6, 11, TV1DY, WHITE, BLACK);
        //OUT8  顶灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 7, 21, DDSC, WHITE, BLACK);
        //OUT9  厢灯1输出
        LCD_DrawImageSBPP(60, 75 + 25 * 8, 21, XD1SC, WHITE, BLACK);
        //OUT10 厢灯2输出
        LCD_DrawImageSBPP(60, 75 + 25 * 9, 21, XD2SC, WHITE, BLACK);
        //OUT11 中门开输出
        LCD_DrawImageSBPP(60, 75 + 25 * 10, 21, ZMKSC, WHITE, BLACK);
        //OUT12 中门关输出
        LCD_DrawImageSBPP(60, 75 + 25 * 11, 21, ZMGSC, WHITE, BLACK);
        //OUT13 前门开输出
        LCD_DrawImageSBPP(60, 75 + 25 * 12, 21, QMKSC, WHITE, BLACK);
        //OUT14 前门关输出
        LCD_DrawImageSBPP(60, 75 + 25 * 13, 21, QMGSC, WHITE, BLACK);
        //OUT15 TV2电源
        LCD_DrawImageSBPP(60, 75 + 25 * 14, 11, TV2DY, WHITE, BLACK);              
        /************************顶模块开关*********************************/
        //KL1  
        //KL2  
        //KL3  
        ...
        /*********************后模块输出***************************************/
        //OUT1  启动接触器
        LCD_DrawImageSBPP(60, 75 + 25 * 0, 42, QDJCQ, WHITE, BLACK);
        //OUT2  排风扇1
        LCD_DrawImageSBPP(60, 75 + 25 * 1, 42, FSSC1, WHITE, BLACK);
        //OUT3  干燥器
        LCD_DrawImage1BPP(60, 75 + 25 * 2, BMP_Ganzaoqi, WHITE, BLACK);
        //OUT4  倒车灯
        LCD_DrawImageSBPP(60, 75 + 25 * 3, 42, DCDSC, WHITE, BLACK);
        //OUT5  制动灯
        LCD_DrawImageSBPP(60, 75 + 25 * 4, 42, ZDDSC, WHITE, BLACK);
        //OUT6  后雾灯
        ...
        LCD_DrawImage1BPP(60 + 63, 75 + 25 * 7, BMP_IC_Deng, WHITE, BLACK);
        //OUT9  门泵电源
        LCD_DrawImageSBPP(60, 75 + 25 * 8, 21, MBDY, WHITE, BLACK);
        //OUT10 小灯
        LCD_DrawImageSBPP(60, 75 + 25 * 9, 21, XD, WHITE, BLACK);
        //OUT11 中门灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 10, 21, ZMDSC, WHITE, BLACK);
        //OUT12 顶灯输出
        LCD_DrawImageSBPP(60, 75 + 25 * 11, 21, DDSC, WHITE, BLACK);
        //OUT13 厢灯1输出
        LCD_DrawImageSBPP(60, 75 + 25 * 12, 21, XD1SC, WHITE, BLACK);
        //OUT14 厢灯2输出
        LCD_DrawImageSBPP(60, 75 + 25 * 13, 21, XD2SC, WHITE, BLACK);
        //OUT15 门开信号
        LCD_DrawImageSBPP(60, 75 + 25 * 14, 21, MKXH, WHITE, BLACK);                      
        /*********************后模块开关***************************************/
        //KL1
        //KL2  制动开关
        LCD_DrawImageSBPP(285 + 150, 75 + 25 * 1, 42, ZDKG, WHITE, BLACK);
        //KL3
        //KL4
        //KL5  驻车制动开关
        ...
        //KL7  空滤报警
        LCD_DrawImageSBPP(285 + 150, 75 + 25 * 6, 42, KLBJ, WHITE, BLACK); 
        //KL8  右后摩擦片报警
        ...
        //KL9  水位报警
        LCD_DrawImage1BPP(285 + 150, 75 + 25 * 8, BMP_Shuiwei, WHITE, BLACK);
        LCD_DrawImage1BPP(285 + 150 + 42, 75 + 25 * 8, BMP_Baojing, WHITE, BLACK);
        //KL10 后舱门
        LCD_DrawImage1BPP(285 + 150, 75 + 25 * 9, BMP_IC_Hou, WHITE, BLACK);
        LCD_DrawImage1BPP(285 + 150 + 21, 75 + 25 * 9, BMP_Cangmen, WHITE, BLACK);
        LCD_DrawImage1BPP(285 + 150 + 63, 75 + 25 * 9, BMP_IC_Kaiguan, WHITE, BLACK);
        //KL11 左前摩擦片报警
        LCD_DrawImage1BPP(285 + 150, 75 + 25 * 10, BMP_IC_Zuo, WHITE, BLACK);
        LCD_DrawImage1BPP(285 + 150 + 21, 75 + 25 * 10, BMP_IC_Qian, WHITE, BLACK);
        ...
        print_SZ_2(285 + 150 + 84 + 6, 75 + 25 * 13, 2, 1, 0, WHITE);
        //KL15 后启动
        LCD_DrawImageSBPP(285 + 150, 75 + 25 * 14, 21, HQD, WHITE, BLACK); 
        //KH1  发动机输出
...
void MenuFrame(void) {
    ...
    LCD_DrawImageSBPP(130, 130 + 35, 75, ENG_SYSTEM, color, BLACK); //发动机
    ...
    LCD_DrawImageSBPP(130 + 350, 130, 75, PDH_SYSTEM, color, BLACK); //配电盒
...
void MOTOFrame(unsigned char index) {
    ...
    if (index == 1) {
        LCD_DrawImageSBPP(82, 100, 42, DJMXDY, WHITE, BLACK); //电机母线电压
        LCD_DrawImage1BPP(400 - 24, 100 + 38 * 0, BMP_v, WHITE, BLACK); //V
        
        LCD_DrawImageSBPP(82, 100 + 38, 42, DJMXDL, WHITE, BLACK); //电机母线电流
        LCD_DrawImage1BPP(400 - 24, 100 + 38 * 1, BMP_a, WHITE, BLACK); //V
        
        LCD_DrawImageSBPP(82, 100 + 38 * 2, 42, PJWD, WHITE, BLACK); //平均温度
        LCD_DrawImage1BPP(400 - 24, 100 + 38 * 2, BMP_T, WHITE, BLACK); //V
        
        //LCD_DrawImageSBPP(82, 100 + 38 * 3, 21, DRDY, WHITE, BLACK); //电容电压
        //LCD_DrawImage1BPP(400 - 24, 100 + 38 * 3, BMP_v, WHITE, BLACK); //V
        
        LCD_DrawImageSBPP(82, 100 + 38 * 4, 42, ZDTB, WHITE, BLACK); //制动踏板
        LCD_DrawImage1BPP(400 - 24, 100 + 38 * 4, BMP_Baifenhao, WHITE, BLACK); //%
        
        
        
        //LCD_DrawImageSBPP(82 + 320, 100 + 38 * 0, 11, SOE, WHITE, BLACK); //SOE
        //LCD_DrawImage1BPP(400 + 320 - 24, 100 + 38 * 0, BMP_Baifenhao, WHITE, BLACK); //%
        
        LCD_DrawImageSBPP(82 + 320, 100 + 38 * 1, 42, SCZS, WHITE, BLACK); //输出转速
        LCD_DrawImageSBPP(400 + 320 - 24 - 15, 100 + 38 * 1,11, CHAR_RPM, WHITE, BLACK); //RPM
        
        LCD_DrawImageSBPP(82 + 320, 100 + 38 * 2, 11, EV, WHITE, BLACK); //EV信号
        
        LCD_DrawImageSBPP(82 + 320, 100 + 38 * 3, 21, TJZT, WHITE, BLACK); //停机状态
        
        LCD_DrawImageSBPP(82 + 320, 100 + 38 * 4, 42, YMTB, WHITE, BLACK); //油门踏板
        LCD_DrawImage1BPP(400 + 320 - 24, 100 + 38 * 4, BMP_Baifenhao, WHITE, BLACK); //%
...
void MOTOUpdate(unsigned char index) {
    print_SZ_1(82 + 200, 100 - 8 + 38 * 0, CAN_0x18EF4AEF.moto_voltage * 4, 4, 0, WHITE);
    updata_DAT(82 + 200 + 16, 100 - 8 + 38 * 1, CAN_0x18EF4AEF.moto_current, 4, 500, WHITE, 3, 0);
    updata_DAT(82 + 200 + 16, 100 - 8 + 38 * 2, CAN_0x18EF4AEF.battle_t, 1, 40, WHITE, 3, 0);
    //print_SZ_1(82 + 200 + 16, 100 - 8 + 38 * 3, CAN_0x18EF4BEF.CAP_voltage * 2, 3, 0, WHITE);
    print_SZ_1(82 + 200 + 16, 100 - 8 + 38 * 4, CAN_0x18EF4CEF.Brake_percent, 3, 0, WHITE);

    //print_SZ_1(82 + 200 + 320 + 16, 100 - 8 + 38 * 0, CAN_0x18EF4BEF.CAP_SOE * 0.4, 3, 0, WHITE);
    print_SZ_1(82 + 200 + 320, 100 - 8 + 38 * 1, Speed_rmp * 0.125, 4, 0, WHITE);
    print_SZ_1(82 + 200 + 320 + 16 * 3, 100 - 8 + 38 * 2, CAN_0x18EF4BEF.EV, 1, 0, WHITE);
    print_SZ_1(82 + 200 + 320 + 16 * 3, 100 - 8 + 38 * 3, CAN_0x18EF4BEF.Engine_wait, 1, 0, WHITE);
    print_SZ_1(82 + 200 + 320 + 16, 100 - 8 + 38 * 4, speed_st * 0.4, 3, 0, WHITE);
    if (index == 1) {
...
void ENGFrame(void) {
    ...
    LCD_Clear();
    LCD_DrawRect(0, 70, 800, 2, YELLOW); //顶部横线
    LCD_DrawImageSBPP(130 + 200 - 15, 130 - 85, 75, ENG_SYSTEM, WHITE, BLACK); //发动机
    ...
    for(i = 0;i<4;i++){
        LCD_DrawImage1BPP(82, 100 + 38 * i, BMP_Fadongji, WHITE, BLACK);
    }
    LCD_DrawImageSBPP(82, 100, 63, FDJZS, WHITE, BLACK);
    LCD_DrawImageSBPP(400 - 24 - 22, 100, 11, CHAR_RPM, WHITE, BLACK); //RPM

    LCD_DrawImageSBPP(82, 100 + 38, 63, FDJQH, WHITE, BLACK);
    LCD_DrawImageSBPP(400 - 24 - 22, 100 + 38, 11, CHAR_LH, WHITE, BLACK); //LH

    LCD_DrawImageSBPP(82, 100 + 38 * 2, 63, FDJSW, WHITE, BLACK);
    LCD_DrawImage1BPP(400 - 24 - 22, 100 + 38 * 2, BMP_T, WHITE, BLACK); //℃

    LCD_DrawImageSBPP(82, 100 + 38 * 3, 63, FDJYM, WHITE, BLACK);
    LCD_DrawImage1BPP(400 - 24 - 22, 100 + 38 * 3, BMP_Baifenhao, WHITE, BLACK); //%
    
    LCD_DrawImageSBPP(82, 100 + 38 * 4, 42, HHDLGZ, YELLOW, BLACK); //混合动力故障

    LCD_DrawImageSBPP(82 + 82 + 63, 100 + 38 * 4, 11, CHAR_SPN, YELLOW, BLACK); //SPN

    LCD_DrawImageSBPP(82 + 82 + 63 + 105, 100 + 38 * 4, 11, CHAR_FMI, YELLOW, BLACK); //SPN

    for (i = 0; i < 5; i++) {
        LCD_DrawImage1BPP(82, 100 - 8 + 38 * (i + 5), BMP_SZ_1[i + 1], YELLOW, BLACK);
    }
    
    
    
    for(i = 0;i<4;i++){
        LCD_DrawImage1BPP(82 + 320, 100 + 38 * i, BMP_Fadongji, WHITE, BLACK);
    }
    LCD_DrawImageSBPP(82 + 320 + 63, 100 + 38 * 0, 42, JYYL, WHITE, BLACK);
    LCD_DrawImageSBPP(400 + 320 - 24 - 22, 100 + 38 * 0, 11, CHAR_MPA, WHITE, BLACK); //MPA

    LCD_DrawImageSBPP(82 + 320 + 63, 100 + 38 * 1, 42, JQWD, WHITE, BLACK);
    LCD_DrawImage1BPP(400 + 320 - 24 - 22, 100 + 38 * 1, BMP_T, WHITE, BLACK); //℃

    LCD_DrawImageSBPP(82 + 320 + 63, 100 + 38 * 2, 42, JQYL, WHITE, BLACK);
    LCD_DrawImageSBPP(400 + 320 - 24 - 22, 100 + 38 * 2, 11, CHAR_KPA, WHITE, BLACK); //KPA

    LCD_DrawImageSBPP(82 + 320 + 63, 100 + 38 * 3, 42, ZYYL, WHITE, BLACK);
    LCD_DrawImageSBPP(400 + 320 - 24 - 22, 100 + 38 * 3, 11, CHAR_KPA, WHITE, BLACK); //KPA
    
    


    LCD_DrawImageSBPP(82 + 320, 100 + 38 * 4, 42, CDXTGZ, YELLOW, BLACK); //传动系统故障

    LCD_DrawImageSBPP(82 + 82 + 320 + 63, 100 + 38 * 4, 11, CHAR_SPN, YELLOW, BLACK); //SPN

    LCD_DrawImageSBPP(82 + 82 + 320 + 63 + 105, 100 + 38 * 4, 11, CHAR_FMI, YELLOW, BLACK); //SPN

    for (i = 0; i < 5; i++) {
        LCD_DrawImage1BPP(82 + 320, 100 - 8 + 38 * (i + 5), BMP_SZ_1[i + 1], YELLOW, BLACK);
    }
...
void ENGUpdate(void) {
    unsigned char i = 0;
    print_SZ_1(82 + 200 + 20 - 32, 100 - 8, EngineSpeed / 8, 4, 0, WHITE);
    print_SZ_1(82 + 200 + 20 - 48 - 32, 100 - 8 + 38, fuel_rate * 5, 6, 2, WHITE);
    updata_DAT(82 + 200 + 20 - 16, 100 - 8 + 38 * 2, water_temp, 1, 40, WHITE, 3, 0);
    print_SZ_1(82 + 200 + 20 - 16, 100 - 8 + 38 * 3, speed_st * 0.4, 3, 0, WHITE);
    
    for (i = 0; i < 5; i++) {
        DM(i + 1, CAN_18FECAEF);
        print_SZ_1(82 + 100 - 16, 100 - 8 + 38 * (i + 5), SPN, 6, 0, GREEN);
        print_SZ_1(82 + 100 + 128 + 16, 100 - 8 + 38 * (i + 5), FMI, 2, 0, GREEN);
    }
    
    
    
    print_SZ_1(82 + 200 + 320 + 20 - 32, 100 - 8 + 38 * 0, Engine_oil_press / 10, 3, 2, WHITE);
    updata_DAT(82 + 200 + 320 + 20 - 16, 100 - 8 + 38 * 1, ambient_air_temperature, 1, 40, WHITE, 3, 0);
    print_SZ_1(82 + 200 + 320 + 20 - 32, 100 - 8 + 38 * 2, air_pressure * 5, 3, 1, WHITE);
    print_SZ_1(82 + 200 + 320 + 20 - 32, 100 - 8 + 38 * 3, barometric_pressure * 5, 3, 1, WHITE);

    for (i = 0; i < 5; i++) {
        DM(i + 1, CAN_18FECA03);
        print_SZ_1(82 + 100 + 320 - 16, 100 - 8 + 38 * (i + 5), SPN, 6, 0, GREEN);
        print_SZ_1(82 + 100 + 320 + 128 + 16, 100 - 8 + 38 * (i + 5), FMI, 2, 0, GREEN);
    }
}
...
/******************************************************/
void PDHFrame(unsigned char index) {
    unsigned char i;
    LCD_Clear();
    LCD_DrawRect(0, 70, 800, 2, YELLOW); //顶部横线
    LCD_DrawImageSBPP(130 + 200 + 24, 130 - 85, 75, PDH_SYSTEM, WHITE, BLACK); //配电盒
    ...
    LCD_DrawImage1BPP(82, 100, BMP_Xu, WHITE, BLACK); //蓄电池电压
    LCD_DrawImage1BPP(82 + 21, 100, BMP_DC, WHITE, BLACK);
    LCD_DrawImage1BPP(82 + 21 + 42, 100, BMP_DY, WHITE, BLACK);
    LCD_DrawImage1BPP(400 - 24 - 22, 100 + 38 * 0, BMP_v, WHITE, BLACK); //V

    LCD_DrawImage1BPP(82, 100 + 38, BMP_Xu, WHITE, BLACK); //蓄电池电流
    LCD_DrawImage1BPP(82 + 21, 100 + 38, BMP_DC, WHITE, BLACK);
    LCD_DrawImage1BPP(82 + 21 + 42, 100 + 38, BMP_DL, WHITE, BLACK);
    LCD_DrawImage1BPP(400 - 24 - 22, 100 + 38 * 1, BMP_a, WHITE, BLACK); //A

    LCD_DrawImageSBPP(82, 100 + 38 * 2, 63, PDHWD, WHITE, BLACK);
    LCD_DrawImage1BPP(400 - 24 - 22, 100 + 38 * 2, BMP_T, WHITE, BLACK); //℃

    LCD_DrawImageSBPP(82, 100 + 38 * 3, 42, DYZT, WHITE, BLACK);
...
void PDHUpdate(unsigned char index) { 
