...
#define  F_DISP           gKEY[4].bit1
#define  F_20s            gKEY[4].bit2
#define  F_20s_flag       gKEY[4].bit3
#define  M_flag           gKEY[4].bit4
#define  F3s_1            gKEY[4].bit5
#define  F3s_2            gKEY[4].bit6
#define  F3s_3            gKEY[4].bit7
