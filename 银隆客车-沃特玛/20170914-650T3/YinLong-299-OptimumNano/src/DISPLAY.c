...
void disp_baojing(void) {
    ...
    if (color_old[7] != color) {
        color_old[7] = color;
        LCD_DrawImage1BPP(10 + 66 * 7, 5, Bmp_baojing[7], color, BLACK); //安全门
    }

    if (mKL4 || rKL4) color = RED;
    else color = GRAY;
    ...
    if (color_old[9] != color) {
        color_old[9] = color;
        LCD_DrawImage1BPP(10 + 66 * 9, 5, Bmp_baojing[9], color, BLACK); //水位报警
    }
    ...
    if (!rKL5 && DMC_Status == 0) color = RED;
    else color = BLACK;
...
void ICFrame(unsigned char index) { //仪表框架
    ...
    print_SZ_2(750, 50, index, 1, 0, WHITE); // ？/4
    ...
    if (index == 1) {
        ...
        //IN6
        //IN7  电视机开关
        LCD_DrawImageSBPP(35, 75 + 25 * 6, 63, DSJKG, WHITE, BLACK);
        //IN8
        //IN9  前雾灯
        ...
        //IN18
        //IN19 阅读灯开关
        LCD_DrawImage1BPP(285, 75 + 25 * 2, BMP_Yuedu, WHITE, BLACK);
        LCD_DrawImage1BPP(285 + 42, 75 + 25 * 2, BMP_IC_Deng, WHITE, BLACK);
        //IN20      
        //IN21雨刮喷水
        ...
        //KL3
        //KL4  应急阀报警
        LCD_DrawImageSBPP(285 + 150, 75 + 25 * 3,63, YJFBJ, WHITE, BLACK);
        //KL5
        //KL6  水位报警
...
void AirFrame(void) {
    ...
    LCD_DrawImageSBPP(82 + 320, 100 + 38 * 3, 42, SJGL, WHITE, BLACK); //实际功率
