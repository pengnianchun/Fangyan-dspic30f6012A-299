...
int main(void) {
    ...
    while (1) {
        ...
        if (M_ON) {// ON 闭合   
            ...
            bLCD_RESET = 1; 
            /*if (TM_Feedback_RPM > 15000)
                temp = TM_Feedback_RPM - 15000;
            else temp = 0;*/
            temp = Moto_Rpm * 0.5;
            pSpeed = (unsigned int) (temp * 0.480 * 2 * 60 * 3.14159 / 1000 / 5.571 * 1.05); //半径*2*π*60/1000/减速比
            ...
            if (task == 0) {
                ...
                task = 2;                 
                temp = ADV[3]; //更新水温表程序 最大值1152  步进角度96°
                if (temp < 500)
                    sm_new_value[4] = 0;
                else if (temp > 3000)
                    sm_new_value[4] = 1152;
                ...
                task = 4;
                temp = ADV[4];//更新水温表程序 最大值1152  步进角度96°
                if (temp < 500)
                    sm_new_value[2] = 0;
                else if (temp > 3000)
                    sm_new_value[2] = 1152;
