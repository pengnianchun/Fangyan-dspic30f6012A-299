...
//传统车
#define LED1  alarm_led[1].bit0 //油量低报警        
#define LED2  alarm_led[1].bit1 //空挡指示                         
...
#define LED7  alarm_led[1].bit6 //水温报警 
#define LED8  alarm_led[1].bit7 //右转向报警  
#define LED9  alarm_led[2].bit0 //气压低1报警
#define LED10 alarm_led[2].bit1 //总电源指示              
#define LED11 alarm_led[2].bit2 //气压低2报警
#define LED12 alarm_led[2].bit3 //发动机故障   
#define LED13 alarm_led[2].bit4 //油中积水           
#define LED14 alarm_led[2].bit5 //OBD报警                 
#define LED15 alarm_led[2].bit6 //发动机诊断
...
#define LED6  alarm_led[1].bit5 //动力电池充电指示-电量不足报警 
#define LED7  alarm_led[1].bit6 //充电插头指示  
#define LED8  alarm_led[1].bit7 //右转向报警  
#define LED9  alarm_led[2].bit0 //气压低1报警
#define LED10 alarm_led[2].bit1 //总电源指示              
#define LED11 alarm_led[2].bit2 //气压低2报警
...
#define IN25  sw_input[3].bit0     //
#define IN26  sw_input[3].bit1     //
#define IN27  sw_input[3].bit2     //
