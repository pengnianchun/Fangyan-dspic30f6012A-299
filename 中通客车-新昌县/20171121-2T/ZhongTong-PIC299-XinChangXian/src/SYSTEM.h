...
//百米脉冲数  双钱10R22.5  滚动半径494.9mm  主减速比5.85  8脉冲/周
#define  HM_PLUSE      1390
//背光亮度值
...
#define  Version_date 20171121   //20170726
...
#define  M_ACC            gKEY[4].bit6
#define  F50ms1           gKEY[4].bit7

#define  ECU_DM1_double   gKEY[5].bit1
#define  SCR_DM1_double   gKEY[5].bit2
#define  ETC2_DM1_double  gKEY[5].bit3
#define  ABS_DM1_double   gKEY[5].bit4
#define  QY_S1            gKEY[5].bit5
#define  QY_S2            gKEY[5].bit6
#define  QY_S3            gKEY[5].bit7
...
//动力CAN信息
extern unsigned char engine_oil_press;
...
extern unsigned char ECU_DM2;  //OBD灯报警 
extern unsigned char ECU_WFI;  //油中积水
extern unsigned char ECU_DM1; 
extern unsigned int  speed_st; //油门踏板
extern unsigned char SCR_DM1;    //SCR故障
extern unsigned char SCR_DM2;    //SCR故障
extern unsigned char ADBLUE;     //尿素液位 


extern ECU_DTC  ECU_dtc[8];
extern unsigned int ECU_DTC_NUM;
extern unsigned char  FDJ_TIME;

extern unsigned char ABS_fault;//ABS
extern unsigned char ABS_DM1; 
extern unsigned int ABS_DTC_NUM;
extern ECU_DTC  ABS_dtc[8];

extern unsigned long QT_trip_XHL;//单程累计消耗气体量
extern unsigned long QT_total_XHL;//总的累计消耗气体量
extern unsigned int  QT_SSZL_QH;//瞬时质量气耗
extern unsigned int  QT_SSTJ_QH;//瞬时体积气耗
extern unsigned int  QT_XSZL_QH;//小时质量气耗
extern unsigned int  QT_XSTJ_QH;//小时体积气耗
extern unsigned int  QT_KMZL_QH;//百公里质量气耗
extern unsigned int  QT_KMTJ_QH;//百公里体积气耗

//胎压监测 
extern unsigned char Tire_Press[7];
extern unsigned int  Tire_Temp[7]; 
extern unsigned char Tire_Status[7];
extern unsigned char Tire_fault[7];
extern unsigned char Tire_BK_ST;//备胎状态

extern  unsigned int   Vspeed;
extern  unsigned int   Tfin;
/*****************分包处理CAN*****************/
