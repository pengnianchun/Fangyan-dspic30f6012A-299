...
void LCD_DrawImage4BPP(unsigned int x, unsigned int y, //没有文字，字数填0，字模为BMP_BLANK       
                       //unsigned char witdh, //字体宽度
                         __prog__ const unsigned char *img[], //字符串首地址
                         unsigned char fcolor, //字体前景色
                         unsigned char bcolor  //字体背景色
...
void mainFrame(void) {
    ...
    LCD_DrawRect(0+66*3+4, 64, 800-66*6-8, 1, GRAY);
  ...
  //LCD_DrawImageSBPP(225 + 83 + 83 + 2, 365 - 50 + 10 + 38, 21, XZGSF, WHITE, BLACK);//旋转高速阀
  ...
  //LCD_DrawImageSBPP(180 - 20 + 2, 365 - 50 + 10 + 38, 21, ZDQDKF, WHITE, BLACK); //制动器打开阀
    LCD_DrawImageSBPP(180 - 20 + 2, 365 - 50 + 10 + 38, 21, KBSCS, WHITE, BLACK); //开闭锁次数
    ...
    LCD_DrawImageSBPP(10, 5 + 25 * 0, 21, KSD, WHITE, BLACK);//开箱灯    
    LCD_DrawImageSBPP(10, 5 + 25 * 1, 21, BSD, WHITE, BLACK);// 
    LCD_DrawImageSBPP(10, 5 + 25 * 2, 21, ZXD, WHITE, BLACK);//
    LCD_DrawImageSBPP(10, 5 + 25 * 3, 21, ZXPLD, WHITE, BLACK);// 
    LCD_DrawImageSBPP(10, 5 + 25 * 4, 42, CZQFMS, WHITE, BLACK);//  
    
    
    LCD_DrawImageSBPP(625, 5 + 25 * 0, 42, DJKZQ, WHITE, BLACK); LCD_DrawImage1BPP(625 +105, 5 + 25 * 0,  Bmp_JXu, WHITE, BLACK); 
    LCD_DrawImageSBPP(625, 5 + 25 * 1, 42, DCGLXT, WHITE, BLACK);//  
    
    
    /*
    LCD_DrawImageSBPP(10, 5 + 25 * 0, 21, ZCKSF, WHITE, BLACK);
    LCD_DrawImageSBPP(10, 5 + 25 * 1, 21, ZCBSF, WHITE, BLACK);
    LCD_DrawImageSBPP(10, 5 + 25 * 2, 21, ZCDJShenF, WHITE, BLACK);
    LCD_DrawImageSBPP(10, 5 + 25 * 3, 21, ZCDJSuoF, WHITE, BLACK);
    LCD_DrawImageSBPP(10, 5 + 25 * 4, 21, ZCYF, WHITE, BLACK);
    LCD_DrawImageSBPP(10, 5 + 25 * 5, 21, ZXF, WHITE, BLACK);

    LCD_DrawImageSBPP(10 + 660, 5 + 25 * 0, 21, YCKSF, WHITE, BLACK);
    LCD_DrawImageSBPP(10 + 660, 5 + 25 * 1, 21, YCBSF, WHITE, BLACK);
    LCD_DrawImageSBPP(10 + 660, 5 + 25 * 2, 21, YCDJShenF, WHITE, BLACK);
    LCD_DrawImageSBPP(10 + 660, 5 + 25 * 3, 21, YCDJSuoF, WHITE, BLACK);
    LCD_DrawImageSBPP(10 + 660, 5 + 25 * 4, 21, YCYF, WHITE, BLACK);
    LCD_DrawImageSBPP(10 + 660, 5 + 25 * 5, 21, YXF, WHITE, BLACK);
    */
...
void frmMain(void) {
    if (f_index == 0) { //只更新一次
        ...
        print_SZ_1(313-32, 318 + 38 * 1, BMS_Charge_V, 5, 0, WHITE); //开闭锁次数
    } else if (f_index == 5) {
        f_index = 6;
        ...
        if (DJ_Status[4].bit1) {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 0, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 0, Bmpflag[0], WHITE, BLACK);
        }
        if (DJ_Status[4].bit2) {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 1, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 1, Bmpflag[0], WHITE, BLACK);
        }
        if (DJ_Status[4].bit3) {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 2, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 2, Bmpflag[0], WHITE, BLACK);
        }
        if (DJ_Status[4].bit4) {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 3, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 3, Bmpflag[0], WHITE, BLACK);
        }
        if (DJ_Status[1].bit3) {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 4, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(136+41, 3 + 25 * 4, Bmpflag[0], WHITE, BLACK);
        }

        //第二列
        if (VCU_Fault[0].bit2) {
            LCD_DrawImage1BPP(625-24, 3 + 25 * 0, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(625-24, 3 + 25 * 0, Bmpflag[0], WHITE, BLACK);
        }
        if (VCU_Fault[0].bit3) {
            LCD_DrawImage1BPP(625-24, 3 + 25 * 1, Bmpflag[1], GREEN, BLACK);
        } else {
            LCD_DrawImage1BPP(625-24, 3 + 25 * 1, Bmpflag[0], WHITE, BLACK);
        }
...
void ICFrame(unsigned char index) { //仪表框架
    ...
    if (index == 1) {
        ...
        /***********************仪表开关量采集*********************************/
        /*************************第一列开关***********************************/
        LCD_DrawImage4BPP(35, 75 + 25 * 0, KIN1, WHITE, BLACK);
        LCD_DrawImage4BPP(35, 75 + 25 * 1, KIN2, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 2, KIN3, WHITE, BLACK);
        LCD_DrawImage4BPP(35, 75 + 25 * 3, KIN4, WHITE, BLACK);   
        LCD_DrawImage4BPP(35, 75 + 25 * 4, KIN5, WHITE, BLACK);      
        LCD_DrawImage4BPP(35, 75 + 25 * 5, KIN6, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 6, KIN7, WHITE, BLACK);      
        LCD_DrawImage4BPP(35, 75 + 25 * 7, KIN8, WHITE, BLACK);  
        
        LCD_DrawImage4BPP(35, 75 + 25 * 8,  KIN9, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 9,  KIN10, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 10, KIN11, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 11, KIN12, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 12, KIN13, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 13, KIN14, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 14, KIN15, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 15, KIN16, WHITE, BLACK);  
        
        LCD_DrawImage4BPP(285, 75 + 25 * 0, KIN17, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 1, KIN18, WHITE, BLACK);             
        LCD_DrawImage4BPP(285, 75 + 25 * 2, KIN19, WHITE, BLACK);      
        LCD_DrawImage4BPP(285, 75 + 25 * 3, KIN20, WHITE, BLACK);    
        LCD_DrawImage4BPP(285, 75 + 25 * 4, KIN21, WHITE, BLACK);        
        LCD_DrawImage4BPP(285, 75 + 25 * 5, KIN22, WHITE, BLACK);          
        LCD_DrawImage4BPP(285, 75 + 25 * 6, KIN23, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 7, KIN24, WHITE, BLACK);        
        
        LCD_DrawImage4BPP(285, 75 + 25 * 8, KIN25, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 9, KIN26, WHITE, BLACK);             
        LCD_DrawImage4BPP(285, 75 + 25 * 10, KIN27, WHITE, BLACK);      
        LCD_DrawImage4BPP(285, 75 + 25 * 11, KIN28, WHITE, BLACK);    
      //LCD_DrawImage1BPP(285, 75 + 25 * 12, KIN29, WHITE, BLACK);        
      //LCD_DrawImage1BPP(285, 75 + 25 * 13, KIN30, WHITE, BLACK);          
      //LCD_DrawImage1BPP(285, 75 + 25 * 14, KIN31, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 15, KIN32, WHITE, BLACK);        
        
      //LCD_DrawImage1BPP(535, 75 + 25 * 0, KIN33, WHITE, BLACK);   
      //LCD_DrawImage1BPP(535, 75 + 25 * 1, KIN34, WHITE, BLACK);             
      //LCD_DrawImage1BPP(535, 75 + 25 * 2, KIN35, WHITE, BLACK);      
      //LCD_DrawImage1BPP(535, 75 + 25 * 3, KIN36, WHITE, BLACK);    
      //LCD_DrawImage1BPP(535, 75 + 25 * 4, KIN37, WHITE, BLACK);        
        LCD_DrawImage4BPP(535, 75 + 25 * 5, KIN38, WHITE, BLACK);          
        LCD_DrawImage4BPP(535, 75 + 25 * 6, KIN39, WHITE, BLACK);   
        LCD_DrawImage4BPP(535, 75 + 25 * 7, KIN40, WHITE, BLACK);    
        ...
        LCD_DrawImage1BPP(535 - 21, 75 + 25 * 10, BMP_Youmen, WHITE, BLACK);
        LCD_DrawImage1BPP(535 + 21, 75 + 25 * 10, BMP_Taban,  WHITE, BLACK);      
        LCD_DrawImage1BPP(535 + 63, 75 + 25 * 10, BMP_Xinhao, WHITE, BLACK);
        
        LCD_DrawImage1BPP(535 + 21, 75 + 25 * 14, BMP_Chesu,  WHITE, BLACK);
        LCD_DrawImage1BPP(535 + 63, 75 + 25 * 14, BMP_Xinhao, WHITE, BLACK);
        ...
        /*************************前模块输出***********************************/
        LCD_DrawImage4BPP(60, 75 + 25 * 0, Bmp_front_load_1, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 1, Bmp_front_load_2, WHITE, BLACK);        
        LCD_DrawImage4BPP(60, 75 + 25 * 2, Bmp_front_load_3, WHITE, BLACK);     
        LCD_DrawImage4BPP(60, 75 + 25 * 3, Bmp_front_load_4, WHITE, BLACK);      
        LCD_DrawImage4BPP(60, 75 + 25 * 4, Bmp_front_load_5, WHITE, BLACK);       
        LCD_DrawImage4BPP(60, 75 + 25 * 5, Bmp_front_load_6, WHITE, BLACK);     
        LCD_DrawImage4BPP(60, 75 + 25 * 6, Bmp_front_load_7, WHITE, BLACK);       
        LCD_DrawImage4BPP(60, 75 + 25 * 7, Bmp_front_load_8, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 8, Bmp_front_load_9, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 9, Bmp_front_load_10, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 10, Bmp_front_load_11, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 11, Bmp_front_load_12, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 12, Bmp_front_load_13, WHITE, BLACK);
        LCD_DrawImage4BPP(60, 75 + 25 * 13, Bmp_front_load_14, WHITE, BLACK);       
        LCD_DrawImage4BPP(60, 75 + 25 * 14, Bmp_front_load_15, WHITE, BLACK);
...
void ICUpdate(unsigned char index) {
    ...
    if (index == 1) {
        ...
        for (i = 0; i < 6; i++) {
            ...
            print_SZ_2(535 + 63 + 42 + 4, 75 + 25 * (6 + 8), freq[0], 4, 0, YELLOW);
            print_SZ_2(535 + 63 + 42 + 16 * 5, 75 + 25 * (6 + 8), freq[1], 4, 0, YELLOW);   
...
void MenuFrame(void) {
    ...
    LCD_DrawImageSBPP(130 + 350, 130 + 35 * 1, 50, DJu_SYSTEM, color, BLACK); //吊具  
...
/******************************************************/
void DJuFrame(void) { //吊具框架
    unsigned char i;
    LCD_Clear();
    LCD_DrawRect(0, 70, 800, 2, YELLOW); //顶部横线
    
        LCD_DrawImageSBPP(130 + 200, 130 - 85, 50, DJu_SYSTEM, WHITE, BLACK); //吊具

        /***********************仪表开关量采集*********************************/
        /*************************第一列开关***********************************/
        LCD_DrawImage4BPP(35, 75 + 25 * 0, DJU_KIN1, WHITE, BLACK);
        LCD_DrawImage4BPP(35, 75 + 25 * 1, DJU_KIN2, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 2, DJU_KIN3, WHITE, BLACK);
        LCD_DrawImage4BPP(35, 75 + 25 * 3, DJU_KIN4, WHITE, BLACK);   
        LCD_DrawImage4BPP(35, 75 + 25 * 4, DJU_KIN5, WHITE, BLACK);      
        LCD_DrawImage4BPP(35, 75 + 25 * 5, DJU_KIN6, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 6, DJU_KIN7, WHITE, BLACK);      
        LCD_DrawImage4BPP(35, 75 + 25 * 7, DJU_KIN8, WHITE, BLACK);  
        
        LCD_DrawImage4BPP(35, 75 + 25 * 8,  DJU_KIN9, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 9,  DJU_KIN10, WHITE, BLACK);     
        LCD_DrawImage4BPP(35, 75 + 25 * 10, DJU_KIN11, WHITE, BLACK);     
        //LCD_DrawImage4BPP(35, 75 + 25 * 11, DJU_KIN12, WHITE, BLACK);     
        //LCD_DrawImage4BPP(35, 75 + 25 * 12, DJU_KIN13, WHITE, BLACK);     
        //LCD_DrawImage4BPP(35, 75 + 25 * 13, DJU_KIN14, WHITE, BLACK);     
        //LCD_DrawImage4BPP(35, 75 + 25 * 14, DJU_KIN15, WHITE, BLACK);     
        //LCD_DrawImage4BPP(35, 75 + 25 * 15, DJU_KIN16, WHITE, BLACK);  
        
        LCD_DrawImage4BPP(285, 75 + 25 * 0, DJU_KIN17, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 1, DJU_KIN18, WHITE, BLACK);             
        LCD_DrawImage4BPP(285, 75 + 25 * 2, DJU_KIN19, WHITE, BLACK);      
        LCD_DrawImage4BPP(285, 75 + 25 * 3, DJU_KIN20, WHITE, BLACK);    
        LCD_DrawImage4BPP(285, 75 + 25 * 4, DJU_KIN21, WHITE, BLACK);        
        LCD_DrawImage4BPP(285, 75 + 25 * 5, DJU_KIN22, WHITE, BLACK);          
        LCD_DrawImage4BPP(285, 75 + 25 * 6, DJU_KIN23, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 7, DJU_KIN24, WHITE, BLACK);        
        
        LCD_DrawImage4BPP(285, 75 + 25 * 8, DJU_KIN25, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 9, DJU_KIN26, WHITE, BLACK);             
        LCD_DrawImage4BPP(285, 75 + 25 * 10, DJU_KIN27, WHITE, BLACK);      
        LCD_DrawImage4BPP(285, 75 + 25 * 11, DJU_KIN28, WHITE, BLACK);    
        LCD_DrawImage4BPP(285, 75 + 25 * 12, DJU_KIN29, WHITE, BLACK);        
        LCD_DrawImage4BPP(285, 75 + 25 * 13, DJU_KIN30, WHITE, BLACK);          
        LCD_DrawImage4BPP(285, 75 + 25 * 14, DJU_KIN31, WHITE, BLACK);   
        LCD_DrawImage4BPP(285, 75 + 25 * 15, DJU_KIN32, WHITE, BLACK);        
        
        LCD_DrawImage4BPP(535, 75 + 25 * 0, DJU_KIN33, WHITE, BLACK);   
        LCD_DrawImage4BPP(535, 75 + 25 * 1, DJU_KIN34, WHITE, BLACK);             
        LCD_DrawImage4BPP(535, 75 + 25 * 2, DJU_KIN35, WHITE, BLACK);      
        LCD_DrawImage4BPP(535, 75 + 25 * 3, DJU_KIN36, WHITE, BLACK);    
        //LCD_DrawImage1BPP(535, 75 + 25 * 4, DJU_KIN37, WHITE, BLACK);        
        //LCD_DrawImage4BPP(535, 75 + 25 * 5, DJU_KIN38, WHITE, BLACK);          
        //LCD_DrawImage4BPP(535, 75 + 25 * 6, DJU_KIN39, WHITE, BLACK);   
        //LCD_DrawImage4BPP(535, 75 + 25 * 7, DJU_KIN40, WHITE, BLACK);    
...
void DJuUpdate(void) {
    ...
    unsigned char color;
        ...
        dump = DJ_Status[0].byte + ((unsigned int) (DJ_Status[1].byte) << 8);
        for (i = 0; i < 16; i++) {
            if ((dump & 0x01) == 0x01) {
                LCD_DrawImage1BPP(5, 75 + 25 * i, Bmpflag[1], GREEN, BLACK);
            } else {
        ...
        dump = DJ_Status[2].byte + ((unsigned int) (DJ_Status[3].byte) << 8);
        for (i = 0; i < 16; i++) {
            /*if (i == 9) {//IN26 为控火开关
                if ((dump & 0x01) == 0x01) {
                    LCD_DrawImage1BPP(255, 75 + 25 * i, Bmpflag[0], WHITE, BLACK);
...
void MOTOFrame(unsigned char index) {
    ...
    if (index == 1) {
        ...
        //LCD_DrawImage1BPP(82, 100 + 38 * 5, BMP_Chongdian, WHITE, BLACK); //充电
        //LCD_DrawImage1BPP(82 + 42, 100 + 38 * 5, BMP_Xuqiu, WHITE, BLACK); //需求
        //LCD_DrawImage1BPP(82 + 42 + 42, 100 + 38 * 5, BMP_DY, WHITE, BLACK); //电压
        //LCD_DrawImage1BPP(400 - 24, 100 + 38 * 5, BMP_v, WHITE, BLACK); //V

        //LCD_DrawImage1BPP(82, 100 + 38 * 6, BMP_Chongdian, WHITE, BLACK); //电池
        //LCD_DrawImage1BPP(82 + 42, 100 + 38 * 6, BMP_Xuqiu, WHITE, BLACK); //需求
        //LCD_DrawImage1BPP(82 + 42 + 42, 100 + 38 * 6, BMP_DL, WHITE, BLACK); //电流
        //LCD_DrawImage1BPP(400 - 24, 100 + 38 * 6, BMP_a, WHITE, BLACK); //A               
...
void MOTOUpdate(unsigned char index) {
    ...
    updata_DAT(82 + 200 + 16, 100 - 8 + 38 * 4, MCU_Control_Temp, 1, 40, WHITE, 3, 0);
    //print_SZ_1(82 + 200 + 30 - 32, 100 - 8 + 38 * 5, BMS_Charge_V, 4, 0, WHITE);
    //updata_DAT(82 + 200 + 30 - 32, 100 - 8 + 38 * 6, BMS_Charge_A, 1, 1000, WHITE, 4, 0);   
