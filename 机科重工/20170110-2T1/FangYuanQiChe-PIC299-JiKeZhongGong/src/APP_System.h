...
extern unsigned char GEAR;  //外部CAN换算档位
extern unsigned char LIFE;  //仪表Life信号
extern unsigned int  QY1;   //气压1
extern unsigned int  QY2;   //气压2
