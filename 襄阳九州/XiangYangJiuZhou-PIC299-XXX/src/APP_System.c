...
void SM_Logic(void) {
    ...
    //if (VCU_Motor_RPM > 20000)
    //    RPM = VCU_Motor_RPM - 20000;
    //else RPM = 20000 - VCU_Motor_RPM;
    RPM = VCU_Motor_RPM * 0.5;
    ...
    if (task == 0) {
        ...
        if (temp < 500)
            ...
            sm_new_value[4] = 1152;
        else sm_new_value[4] = (unsigned int) ((temp - 500) * 0.3456);
        SM_Update_4();  //气压1
    } else if (task == 2) {
        task = 3;
        temp = BMS_SOC * 0.5;
        ...
        if (temp < 500)
            ...
            sm_new_value[2] = 1152;
        else sm_new_value[2] = (unsigned int) ((temp - 500) * 0.3456);
        SM_Update_2();  //气压2
    } else if (task == 4) {
        task = 0;
        temp = ADV[0];
