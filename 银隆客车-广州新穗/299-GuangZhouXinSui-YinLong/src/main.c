        ...
        if (M_ON) {// ON 闭合   
            ...
            if (task == 0) {
                ...
                if (temp < 10)
                    ...
                    sm_new_value[4] = ((1152 * 0.3)+((temp - 79) * 9.34));
                else if (temp < 149)
                    sm_new_value[4] = ((1152 * 0.6)+((temp - 116) * 6.98));
                else if (temp < 184)
                    sm_new_value[4] = ((1152 * 0.8)+((temp - 149) * 6.58));
                ...
                if (temp < 10)
                    ...
                    sm_new_value[2] = ((1152 * 0.3)+((temp - 79) * 9.34));
                else if (temp < 149)
                    sm_new_value[2] = ((1152 * 0.6)+((temp - 116) * 6.98));
                else if (temp < 184)
                    sm_new_value[2] = ((1152 * 0.8)+((temp - 149) * 6.58));
