...
//第二列 
  x=500;y=95;
  LCD_DrawImage1BPP(x,y+0*34,Bmp_IN11,WHITE,BLACK); print_SZ_2(x+38,y+0*34,1,1,0,WHITE);
  LCD_DrawImage1BPP(x+56,y+0*34,Bmp_bj,WHITE,BLACK);
  LCD_DrawImage1BPP(x,y+1*34,Bmp_IN12,WHITE,BLACK); print_SZ_2(x+38,y+1*34,2,1,0,WHITE);
  ...
  LCD_DrawImage1BPP(x+18,y+9*34,Bmp_IN20,WHITE,BLACK);//
...
void disp_KL2(void){
  ...
  LCD_DrawImage1BPP(x,y+4*34,Bmp_IN25,WHITE,BLACK);print_SZ_2(x+58,y+4*34,1,1,0,WHITE);  LCD_DrawImage1BPP(x+72,y+4*34,Bmp_A,WHITE,BLACK);
                                                   LCD_DrawImage1BPP(x+88,y+4*34,Bmp_DLiang,WHITE,BLACK);
  
  LCD_DrawImage1BPP(x,y+5*34,Bmp_rear,WHITE,BLACK);  
  LCD_DrawImage1BPP(x+18,y+5*34,Bmp_IN26,WHITE,BLACK);
  ...
  LCD_DrawImage1BPP(x,y+9*34,Bmp_IN30,WHITE,BLACK);print_SZ_2(x+58,y+9*34,2,1,0,WHITE);  LCD_DrawImage1BPP(x+74,y+9*34,Bmp_B,WHITE,BLACK);
                                                   LCD_DrawImage1BPP(x+88,y+9*34,Bmp_DLiang,WHITE,BLACK);  

//第二列 
  x=500;y=95;
  LCD_DrawImage1BPP(x,y+0*34,Bmp_IN31,WHITE,BLACK);print_SZ_2(x+58,y+0*34,2,1,0,WHITE);  LCD_DrawImage1BPP(x+72,y+0*34,Bmp_A,WHITE,BLACK);
                                                   LCD_DrawImage1BPP(x+88,y+0*34,Bmp_DLiang,WHITE,BLACK); 
                                                   
  LCD_DrawImage1BPP(x,y+1*34,Bmp_IN32,WHITE,BLACK);print_SZ_2(x+58,y+1*34,1,1,0,WHITE);  LCD_DrawImage1BPP(x+74,y+1*34,Bmp_B,WHITE,BLACK);
                                                   LCD_DrawImage1BPP(x+88,y+1*34,Bmp_DLiang,WHITE,BLACK); 
  
  LCD_DrawImage1BPP(x,y+2*34,Bmp_IN33,WHITE,BLACK); 
  //LCD_DrawImage1BPP(x+40,y+2*34,Bmp_gd,WHITE,BLACK);
  //LCD_DrawImage1BPP(x+80,y+2*34,Bmp_bj,WHITE,BLACK); 
