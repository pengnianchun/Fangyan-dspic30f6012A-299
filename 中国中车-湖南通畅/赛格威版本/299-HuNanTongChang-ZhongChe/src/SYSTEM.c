...
void Count_ADR(void) {
    ...
    //ADV[7] = (unsigned int) (read_ADR(5) / ad * 5000);
    //ADV[8] = (unsigned int) (read_ADR(6) / ad * 5000);
    //蓄电池电压    
    ...
    //ADR[7] = (unsigned int) (100.0*read_ADR(7)/(ad-read_ADR(7)));
    //ADR[8] = (unsigned int) (100.0*read_ADR(8)/(ad-read_ADR(8)));
    //if (ADR[1] > 1000)
    //    ADR[1] = 0;
    //if (ADR[2] > 1000)
    //    ADR[2] = 0;
...
void BCAN_SendCtl(void) {
    ...
    switch (Model_VERISON) {
        ...
        case 1:
            ...
            message_POUT.data[0] = gCTL[0].byte;
            message_POUT.data[1] = gCTL[1].byte;
            message_POUT.data[2] = gCTL[4].byte;
            message_POUT.data[3] = gCTL[5].byte;
            message_POUT.data[4] = gCTL[2].byte;
            message_POUT.data[5] = gCTL[3].byte;
            ...
            temp.bit2 = IN21; //喷水    
            temp.bit3 = IN15; //间歇
            temp.bit4 = ((M_ON && wake_up3) || wake_up2);
            if (IN16 && IN14)temp.bit1 = 0;
            if (IN21) {
                temp.bit0 = 0; //慢档
                temp.bit1 = 0; //间歇
                temp.bit3 = 0; //快档
