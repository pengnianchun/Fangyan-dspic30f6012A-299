...
//百米脉冲数  滚动半径446mm  主减速比6.14
#define  HM_PLUSE      175 //201
//背光亮度值
...
#define  Version_date 20171222   //20170726
...
extern unsigned int Kcan_count; //电机控制器
extern unsigned int Jcan_count; //记录仪
extern unsigned int JYcan_count;//绝缘监测仪
...
#define  F3s_1            gKEY[4].bit7
#define  F_TaiYa          gKEY[4].bit8
...
extern  unsigned char  YW1_Status[10];//烟雾报警器 检测点在电池箱体内
extern  unsigned char  YZT_LIFE;//云智通状态
extern  unsigned char  YZT_Status;//云智通故障码

extern  unsigned char  VCU_Status[10];//
extern  unsigned char  DC_BOX_SUM;//电池总箱数
extern  unsigned char  Tjc;//电池模块的温度极差
extern  unsigned char  DJ_Status[10];//

extern  unsigned char  GZ_Status[10];//
extern  unsigned char  JLY_time[10];//行车记录仪时间
