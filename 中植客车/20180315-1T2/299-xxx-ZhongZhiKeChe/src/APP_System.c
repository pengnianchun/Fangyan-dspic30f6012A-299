...
void SM_Logic(void) {
    ...
    if (task == 0) {
        ...
        if (temp < 10)
            ...
            sm_new_value[4] = (temp - 10)*5.5;
        else if (temp < 88)
            sm_new_value[4] = 230 + (temp - 52)*6.4;
        else if (temp < 124)
            sm_new_value[4] = 460 + (temp - 88)*6.4;
        else if (temp < 155)
            sm_new_value[4] = 690 + (temp - 124)*7.4;
        else if (temp < 180)
            sm_new_value[4] = 920 + (temp - 155)*9.2;
        else
            sm_new_value[4] = 1152;
        sm_new_value[4] = sm_new_value[4] * 10 / 12;//新刻度纸
        SM_Update_4(); //气压1*/
        temp = ADV[4];//电压型
        if (temp < 500)
            sm_new_value[4] = 0;
        ...
        if (temp < 10)
            ...
            sm_new_value[2] = (temp - 10)*5.5;
        else if (temp < 88)
            sm_new_value[2] = 230 + (temp - 52)*6.4;
        else if (temp < 124)
            sm_new_value[2] = 460 + (temp - 88)*6.4;
        else if (temp < 155)
            sm_new_value[2] = 690 + (temp - 124)*7.4;
        else if (temp < 180)
            sm_new_value[2] = 920 + (temp - 155)*9.2;
        else
            sm_new_value[2] = 1152;
        sm_new_value[2] = sm_new_value[2] * 10 / 12;//新刻度纸
        SM_Update_2();  //气压2*/
        temp = ADV[3];//电压型
        if (temp < 500)
            sm_new_value[2] = 0;
