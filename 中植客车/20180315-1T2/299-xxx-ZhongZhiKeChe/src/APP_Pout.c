...
void SYSTME_Logic(void) {
    ...
    M_PO1 = (IN19);                             //前路牌电源
    M_PO2 = (wake_up3 && IN24);                 //厢灯2
    M_PO3 = (LED15 && IN4);                     //前门踏步灯
    M_PO4 = (fKL6);                             //制动灯
    M_PO5 = (LED15 && IN3);                     //中门踏步灯 
    M_PO6 = (IN19);                             //后路牌
    M_PO7 = (wake_up3 && fKL10);                //后视镜加热
    M_PO8 = (IN9 && IN10 && LED15);             //后雾灯
    M_PO9 = (IN19);                             //侧路牌 //(wake_up2 && IN6 && fKL8); //日行灯
    M_PO10 = (wake_up3 && IN18);                //司机风扇
    M_PO11 = (wake_up3);                        //滚动屏电源
    M_PO12 = (wake_up3 && IN25);                //司机灯
    M_PO13 = (CAN_0x18EF4AEF.EV_Gear == 13);    //倒车灯电源
    M_PO14 = (SPEED < 3);                       //门泵电源
    M_PO15 = (wake_up3 && IN23);                //厢灯1
    M_PO16 = 0;                                 //励磁电流
