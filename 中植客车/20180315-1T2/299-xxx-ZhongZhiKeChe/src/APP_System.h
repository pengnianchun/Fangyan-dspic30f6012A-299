...
#define  WAKE_ACC      wake_up2
#define  WAKE_ON       wake_up3
#define  WAKE_Charge   0
#define  WAKE_Start    0
...
#define  F_CANSend          gKEY[4].bit2
#define  CheckMode          gKEY[4].bit3
#define  checkout           gKEY[4].bit4
