...
//车身内部SOC
  ...
  //后门
  if(IN9)color=RED;else color=WHITE;
  x=199;y=31;    
  ...
  x=199;y=31+88-2;
  lcd_show_1color(X+x, Y+y,48,2,color);//-
  if(IN9)color=BLACK;else color=WHITE;
  x=199+2;y=61;
  ...
  //前门
  if(IN8)color=BLACK;else color=WHITE;  
  x=407-24;y=69-6;
  ...
  if(IN8)color=RED;else color=WHITE;
  x=383;y=31;    
  ...
  //后仓门
  if(IN10)color=RED;else color=BLACK;
  x=24;y=66-14;
...
void disp_baojing2(void){
  ...
  LCD_DrawImage1BPP(214-16,75-18,Bmp_AQD,color,BLACK);//安全带报警 
...
void disp_KL1(void){
  ...
  LCD_DrawImage1BPP(x,y+2*34,Bmp_right,WHITE,BLACK);
  LCD_DrawImage1BPP(x+18,y+2*34,Bmp_IN3,WHITE,BLACK);  
  
  LCD_DrawImage1BPP(x,y+3*34,Bmp_left,WHITE,BLACK); 
  LCD_DrawImage1BPP(x+18,y+3*34,Bmp_IN3,WHITE,BLACK); 
  
  LCD_DrawImage1BPP(x,y+4*34,Bmp_IN4,WHITE,BLACK);
  ...
  LCD_DrawImage1BPP(x+18,y+7*34,Bmp_IN9,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+39,y+7*34,Bmp_Open,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+58,y+7*34,Bmp_ZShi,WHITE,BLACK);//
  
  LCD_DrawImage1BPP(x,y+8*34,Bmp_rear,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+18,y+8*34,Bmp_IN9,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+39,y+8*34,Bmp_Open,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+58,y+8*34,Bmp_ZShi,WHITE,BLACK);//
  
  LCD_DrawImage1BPP(x,y+9*34,Bmp_IN10,WHITE,BLACK);
  LCD_DrawImage1BPP(x+58,y+9*34,Bmp_Open,WHITE,BLACK);//
...
//第二列 
  ...
  LCD_DrawImage1BPP(x+58,y+5*34,Bmp_Gao,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+76,y+5*34,Bmp_wd,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+96,y+5*34,Bmp_bj,WHITE,BLACK);//
  
  LCD_DrawImage1BPP(x,y+6*34,Bmp_IN17,WHITE,BLACK);//
  
  LCD_DrawImage1BPP(x,y+7*34,Bmp_front,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+18,y+7*34,Bmp_IN18,WHITE,BLACK);
  
  LCD_DrawImage1BPP(x,y+8*34,Bmp_rear,WHITE,BLACK);//
  LCD_DrawImage1BPP(x+18,y+8*34,Bmp_IN19,WHITE,BLACK);// 
  
  LCD_DrawImage1BPP(x,y+9*34,Bmp_IN20,WHITE,BLACK);//
  
  unsigned int Iid1[20]={0,120,136,136,0,136,136,178,178,156,
                         0,0,0,0,0,636,540,556,556,0};
  disp_kg(Iid1);  //显示开关
}
//显示仪表开关2
void disp_KL2(void){
  ...
  LCD_DrawImage1BPP(x+36,y+0*34,Bmp_IN21, WHITE,BLACK);
  ...
  LCD_DrawImage1BPP(x+38,y+3*34,Bmp_adr,WHITE,BLACK);
  ...
  LCD_DrawImage1BPP(x+18,y+8*34,Bmp_front, WHITE,BLACK); 
  LCD_DrawImage1BPP(x+36,y+8*34,Bmp_IN29, WHITE,BLACK);
  LCD_DrawImage1BPP(x+92,y+8*34,Bmp_bj, WHITE,BLACK);
  
  LCD_DrawImage1BPP(x,y+9*34,Bmp_IN30,WHITE,BLACK);
  LCD_DrawImage1BPP(x+58,y+9*34,Bmp_bj,WHITE,BLACK);
//第二列 
  x=500;y=95;
  LCD_DrawImage1BPP(x,y+0*34,Bmp_IN31,WHITE,BLACK);
  LCD_DrawImage1BPP(x+40,y+0*34,Bmp_GYing,WHITE,BLACK);
  LCD_DrawImage1BPP(x+80,y+0*34,Bmp_bj,WHITE,BLACK);
  ...
  unsigned int Iid1[20]={212,176,176,156,0,0,0,0,212,178,
                         620,0,0,0,0,0,0,580,540,556,};
  disp_kg(Iid1);  //显示开关
}
...
//第一列
  ...
  LCD_DrawImage1BPP(x,y+7*34,Bmp_front_load8, WHITE,BLACK);  LCD_DrawImage1BPP(x+58,y+7*34,Bmp_dy, WHITE,BLACK);
...
//第二列 
  ...
  unsigned int Iid1[20]={0,0,0,0,0,138,0,0,0,160,
...
//第一列
  ...
  LCD_DrawImage1BPP(x,y+9*34,Bmp_front,WHITE,BLACK);
  LCD_DrawImage1BPP(x+18,y+9*34,Bmp_RKL10,WHITE,BLACK);
...
//第二列 
  ...
  LCD_DrawImage1BPP(x+18,y+1*34,Bmp_RKL12,WHITE,BLACK);
  LCD_DrawImage1BPP(x+56,y+1*34,Bmp_bj,WHITE,BLACK);
    ...
    if (alarm_update_flag == 0) { //3S 更新一次 
        ...
        switch (al_index) {
            ...
            case 27: 
                al_index=28; 
                //if(1){
               if(M_ON &&(IN31==0)&&((system_state&0x30)==0x00)){    //重力感应报警
                LCD_DrawImage1BPP(x,    y, Bmp_ZLi,   Fcolor,color);
                LCD_DrawImage1BPP(x+40, y, Bmp_GYing, Fcolor,color); 
                LCD_DrawImage1BPP(x+80, y, Bmp_bj,    Fcolor,color);                 
                w=x+80+40;LCD_DrawRect(w, y, 250-w, 36, color);
                alarm_update_flag = 1;
                break; 
            ...
            case 28: 
                al_index=0; 
                //if(1){
               if((M_ON && IN16)){    // 缓速器高温报警
                LCD_DrawImage1BPP(x,    y, Bmp_HSQi,  Fcolor,color);
                LCD_DrawImage1BPP(x+56, y, Bmp_Gao,   Fcolor,color); 
                LCD_DrawImage1BPP(x+72, y, Bmp_wd,    Fcolor,color);    
                LCD_DrawImage1BPP(x+90, y, Bmp_bj,    Fcolor,color);   
                w=x+90+40;LCD_DrawRect(w, y, 250-w, 36, color);
                alarm_update_flag = 1;
                break; 
                }  
