...
//第二列 
  ...
  unsigned int Iid1[20]={160,118,0,0,0,136,136,136,0,0,
...
//第一列
  ...
  LCD_DrawImage1BPP(x+56,y+4*34,Bmp_dy, WHITE,BLACK);
...
//第二列
  ...
  LCD_DrawImage1BPP(x+99,y+1*34,Bmp_dy,WHITE,BLACK);
...
//第一列
  ...
  LCD_DrawImage1BPP(x+80,y+2*34,Bmp_dy,WHITE,BLACK);  
...
//第二列
  ...
  LCD_DrawImage1BPP(x+40,y+3*34,Bmp_rear_load14,WHITE,BLACK);//
...
//第一列
  ...
  LCD_DrawImage1BPP(x,y+1*34,Bmp_Dian, WHITE,BLACK);
  LCD_DrawImage1BPP(x+18,y+1*34,Bmp_RKL2, WHITE,BLACK);
  
  LCD_DrawImage1BPP(x,y+2*34,Bmp_RKL3, WHITE,BLACK);
  
  LCD_DrawImage1BPP(x,y+3*34,Bmp_Qi, WHITE,BLACK); 
  LCD_DrawImage1BPP(x+18,y+3*34,Bmp_RKL4, WHITE,BLACK);
...
//第二列 
  ...
  unsigned int Iid1[20]={176,136,0,136,0,136,0,120,0,0,
