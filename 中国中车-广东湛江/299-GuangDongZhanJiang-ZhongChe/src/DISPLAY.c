...
*/
    ...
    LCD_DrawImage1BPP(222 - 24, 280, BMP_V, WHITE, BLACK); //电机控制器电压
    LCD_DrawImage1BPP(222-24, 280+40, BMP_A, WHITE, BLACK);//电机控制器电流
    
    LCD_DrawImage1BPP(222 + 56 + 72 + 40 + 12, 320 - 36 * 4 - 5, BMP_V, WHITE, BLACK); //电池电压V
    LCD_DrawImage1BPP(222 + 56 + 72 + 40 + 12, 320 - 36 * 3 - 5, BMP_A, WHITE, BLACK); //电池电流A
    LCD_DrawImage1BPP(222 + 56 + 72 + 40 + 12, 320 - 36 * 2 - 5, BMP_BAIFENHAO, WHITE, BLACK); //电池SOC%

    LCD_DrawImage1BPP(138, 20 + 64 * 2 + 24 + 24, Bmp_baojing[19], WHITE, BLACK); //发动机
    LCD_DrawImage1BPP(138 + 21, 20 + 64 * 2 + 24 + 24 + 12, BMP_e, WHITE, BLACK); //E
    LCD_DrawRect(138 + 55, 20 + 64 * 2 + 24 + 24 + 24, 30, 10, WHITE);
    LCD_DrawImage1BPP(138 + 56 * 1.5, 20 + 64 * 2 + 24 + 24, Bmp_baojing[20], WHITE, BLACK); //框(左上)
    LCD_DrawImage1BPP(138 + 56 * 1.5 + 18, 20 + 64 * 2 + 24 + 24 + 12, BMP_g, WHITE, BLACK); //G
    //LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5+18+16, 20 + 64 * 2 + 24 + 24+12, BMP_m, WHITE, BLACK); //M
    LCD_DrawRect(138 + 56 * 1.5 + 16, 20 + 64 * 2 + 48 + 24 + 24, 24, 48, WHITE);
    LCD_DrawImage1BPP(138 + 56 * 1.5, 20 + 64 * 2 + 48 * 2 + 24 + 24, Bmp_baojing[20], WHITE, BLACK); //框(左下)
    LCD_DrawImage1BPP(138 + 56 * 1.5 + 18, 20 + 64 * 2 + 24 + 24 + 12 + 48 * 2, BMP_g, WHITE, BLACK); //G
    LCD_DrawImage1BPP(138 + 56 * 1.5 + 18 + 11, 20 + 64 * 2 + 24 + 24 + 12 + 48 * 2, BMP_c, WHITE, BLACK); //C
    
    LCD_DrawRect(138 + 56 * 1.5 + 56, 20 + 64 * 2 + 48 * 2 + 24 + 24 + 12, 40, 24, WHITE);
    
    LCD_DrawImage1BPP(138 + 56 * 1.5 + 48 * 2, 20 + 64 * 2 + 48 * 2 + 24 + 12 + 24, Bmp_Dianchi, WHITE, BLACK); //电池符号片
    LCD_DrawImage1BPP(138 + 56 * 1.5 + 48 * 2 + 24, 20 + 64 * 2 + 48 * 2 + 24 - 20 + 12 + 24, Bmp_Dianchi, WHITE, BLACK); //电池
    
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 48 * 2 +6, 20 + 64 * 2 + 48 * 2 + 24 + 12 + 24 + 36+20, Bmp_Chatou, WHITE, BLACK); //插头
    LCD_DrawRect(6 + 66 * 2 + 56 * 1.5 + 48 * 2 + 12, 20 + 64 * 2 + 48 * 2 + 24 + 24 + 44, 24, 24, YELLOW);
    
    LCD_DrawRect(6 + 66 * 2 + 56 * 1.5 + 56 + 72 + 40, 20 + 64 * 2 + 48 * 2 + 24 + 24 + 12, 50, 24, WHITE);

    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 48 * 4.5, 20 + 64 * 2 + 24 + 24, Bmp_baojing[20], WHITE, BLACK); //框(右上)
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 18+48*4.5, 20 + 64 * 2 + 24 + 24 + 12, BMP_m, WHITE, BLACK); //G
    LCD_DrawRect(6 + 66 * 2 + 56 * 1.5 + 16 + 48 * 4.5, 20 + 64 * 2 + 48 + 24 + 24, 24, 48, WHITE);
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 48 * 4.5, 20 + 64 * 2 + 48 * 2 + 24 + 24, Bmp_baojing[20], WHITE, BLACK); //框(右下)
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 18+48*4.5, 20 + 64 * 2 + 24 + 24 + 12 + 48 * 2, BMP_m, WHITE, BLACK); //G
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 18 + 11+48*4.5, 20 + 64 * 2 + 24 + 24 + 12 + 48 * 2, BMP_c, WHITE, BLACK); //C

    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 48 * 6.5 + 24, 20 + 64 * 2 + 24 - 24 - 24 + 24, Bmp_Luntai, WHITE, BLACK); //轮胎
    LCD_DrawRect(6 + 66 * 2 + 56 * 1.5 + 48 * 4.5 + 56, 20 + 64 * 2 + 24 + 24 + 12, 90, 24, WHITE);
    LCD_DrawRect(6 + 66 * 2 + 56 * 1.5 + 48 * 4.5 + 56 + 90, 20 + 64 * 2 + 24 + 24 + 12 - 28, 12, 90, WHITE);
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 48 * 6.5 + 24, 20 + 64 * 2 + 24 + 48 + 24 + 24, Bmp_Luntai, WHITE, BLACK); //轮胎

    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 - 24 + 56 + 24, 320 + 32, BMP_T, WHITE, BLACK); //℃发电机控制器温度
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 - 24 + 56 + 24 + 48 * 4.5, 320 + 32, BMP_T, WHITE, BLACK); //℃电机控制器温度
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 - 24 + 56 + 24, 320 + 32 - 48 * 3.5 - 12, BMP_T, WHITE, BLACK); //℃发电机温度
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 - 24 + 56 + 24 + 48 * 4.5, 320 + 32 - 48 * 3.5 - 12, BMP_T, WHITE, BLACK); //℃电机温度
    
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 - 24 + 56 + 24 + 48 * 4.5,  320 + 32 - 48 * 3.5 - 12-36, BMP_RPM, WHITE, BLACK); //RPM
    
    LCD_DrawImage1BPP(225 + 83 + 83 + 2, 365 - 50 + 10 + 38*2, BMP_System, WHITE, BLACK); //系统
    LCD_DrawImage1BPP(225 + 83 + 83 + 2 + 43, 365 - 50 + 10 + 38*2, BMP_Code, WHITE, BLACK); //代码

    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 56, 20 + 64 * 2 + 48 * 2 + 24 + 24 + 12 - 50, BMP_s, WHITE, BLACK); //S
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 56 + 11, 20 + 64 * 2 + 24 + 24 + 12 + 48 * 2 - 50, BMP_o, WHITE, BLACK); //O
    LCD_DrawImage1BPP(6 + 66 * 2 + 56 * 1.5 + 56 + 11 + 11, 20 + 64 * 2 + 24 + 24 + 12 + 48 * 2 - 50, BMP_c, WHITE, BLACK); //C
...
void disp_baojing(void) {
    ...
    if (mKL2 && M_ON) color = GREEN;
    else color = GRAY;
    if (color_old[0] != color) {
        color_old[0] = color;
        LCD_DrawImage1BPP(6, 10, Bmp_baojing[18], color, BLACK); //门铃
    }
    ...
    if (mKL4 && M_ON) color = RED;
    else color = GRAY;
    if (color_old[4] != color) {
        color_old[4] = color;
        LCD_DrawImage1BPP(6 + 66 * 4, 10, Bmp_baojing[17], color, BLACK); //干燥
    }
    ...
    /*//无法清空
    if (Tradition) color_mode[0] = GREEN;
    ...
    //可清空
    /*
    if ((Tradition && !Hybrid && !Electric) && M_ON) color_mode[0] = GREEN;
    else if ((!Tradition && Hybrid && !Electric) && M_ON) color_mode[1] = GREEN;
    else if ((!Tradition && !Hybrid && Electric) && M_ON) color_mode[2] = GREEN;
    */

    if ( Hybrid )  color_mode[0] = GREEN;
    else if ( Hybrid )  color_mode[1] = GREEN;
    else if ( Electric) color_mode[2] = GREEN;
    else {
        color_mode[0] = GRAY;
        color_mode[1] = GRAY;
        color_mode[2] = GRAY;
    ...
    }else if (color_old[13] != color_mode[1]) {
        color_old[13] = color_mode[1];
        if( color_mode[1] == GREEN ){
        LCD_DrawImage1BPP(138 + 9, 74, BMP_Chadian, color_mode[1], BLACK); //插电
        LCD_DrawImage1BPP(138 + 9, 74 + 22, BMP_Mode, color_mode[1], BLACK); //模式
        }
    }else if (color_old[14] != color_mode[2]) {
        color_old[14] = color_mode[2];
        if( color_mode[2] == GREEN ){
        LCD_DrawImage1BPP(138 + 9, 74, BMP_Chundian, color_mode[2], BLACK); //纯电
        LCD_DrawImage1BPP(138 + 9, 74 + 22, BMP_Mode, color_mode[2], BLACK); //模式
    ...
    if(color_mode[0] == GRAY && color_mode[1] == GRAY && color_mode[2] == GRAY){
    ...
    */
    ...
    if (Battery_Kt && M_ON) color = GREEN;
    else color = GRAY;
...
void updata_DJMcuDY(unsigned int x, unsigned int y) {
    unsigned int DJDY = 500;
    DJDY = moto_voltage * 0.1;
    if (DJDY < 1000) {
        //LCD_DrawImage1BPPZOOM_4(x - 40, y + 4, BMP_FU, WHITE, BLACK);
...
void updata_DJMcuDL(unsigned int x, unsigned int y) {
    unsigned char color = WHITE;
    unsigned int DJDL = 100;
    DJDL = moto_current * 0.1;
    if (DJDL < 1000) {
...
void frmMain(void) {
    ...
    if (f_index == 0) { //只更新一次
        ...
        f_index = 3;
        disp_baojing();
        updata_RMP(400 + 24 + 5, 130); //电机转速
        updata_T(400 + 40 + 5, 130 + 32, WHITE, Motor_Temperature, 1, 40); //电机温度
        updata_T(400 + 40 + 5-216, 130 + 32, WHITE, Motor_Temperature, 1, 40); //发电机温度
    } else if (f_index == 3) {
        f_index = 4;
        disp_miles();
        updata_DCDL(222 + 56 + 72 + 40 + 12 - 16 * 3.5, 320 - 36 * 3 - 5 - 33 + 36); //电池电流
    } else if (f_index == 4) {
        f_index = 5;
        disp_time(330, 440, timer);
        updata_T(400 + 40 + 5, 130 + 32 + 144 + 36, WHITE, Inverter_t, 1, 40); //电机逆变器温度
        updata_T(400 + 40 + 5-216, 130 + 32 + 144 + 36, WHITE, Inverter_t, 1, 40); //发电机逆变器温度
    } else if (f_index == 5) {
        f_index = 6;
        updata_SOC(222 + 56 + 72 + 40 + 12 - 16 * 3.5, 320 - 36 * 3 - 5 - 33 + 36 * 2);
        updata_Dangwei();
    } else if (f_index == 6) {
        f_index = 7;
        updata_DJMcuDY(140, 280); //电机逆变器电压
        updata_DJMcuDL(140, 320); //电机逆变器电流
        updata_DCDY(222 + 56 + 72 + 40 + 12 - 16 * 3.5, 320 - 36 * 3 - 5 - 33); //电池电压
        ...
        print_SZ_1(480 + 30 + 16, 318 + 38*2, TCU_code, 3, 0, color); //系统代码
    } else {
        f_index = 0;
    }
...
void BCUUpdate(unsigned char index) {
    ...
    if (index == 0) {
        ...
        for (i = 0; i < 15; i++) {
            if ((dump & 0x01) == 0x01) {
                if (fPF[i] == 0 || fPF[i] == 1) color = GREEN;
                else if (fPF[i] == 2) color = YELLOW;
                else color = RED;
...
void ControlFrame(void) {
    ...
    LCD_DrawImage1BPP(82 + 21, 100, BMP_DJ, WHITE, BLACK); //电机
    LCD_DrawImage1BPP(82 + 21 + 42, 100, BMP_Zhuansu, WHITE, BLACK); //转速
    LCD_DrawImage1BPP(400 - 42, 100, BMP_RPM, WHITE, BLACK); //RPM
    
    LCD_DrawImage1BPP(82, 100 + 38, BMP_Fadongji, WHITE, BLACK); //发电机
    LCD_DrawImage1BPP(82 + 21, 100 + 38, BMP_DJ, WHITE, BLACK); //
    LCD_DrawImage1BPP(82 + 63, 100 + 38, BMP_KZQ, WHITE, BLACK); //控制器
    //LCD_DrawImage1BPP(82 + 63 + 63, 100 + 38, BMP_Input, WHITE, BLACK); //输入
    LCD_DrawImage1BPP(82 + 63 + 63, 100 + 38, BMP_DL, WHITE, BLACK); //电流
    ...
    //LCD_DrawImage1BPP(82 + 42 + 63, 100 + 38 * 2, BMP_Input, WHITE, BLACK); //输入
    LCD_DrawImage1BPP(82 + 42 + 63, 100 + 38 * 2, BMP_DL, WHITE, BLACK); //电流
    LCD_DrawImage1BPP(400 - 24, 100 + 38 * 2, BMP_a, WHITE, BLACK); //a
    
    LCD_DrawImage1BPP(82, 100 + 3 * 38, BMP_Shuzi, WHITE, BLACK); //数字
    LCD_DrawImage1BPP(82 + 42 , 100 + 3 * 38, BMP_Liang, WHITE, BLACK); //量
    LCD_DrawImage1BPP(82 + 42 + 21 , 100 + 3 * 38, BMP_Zhuangtai, WHITE, BLACK); //状态
    
    LCD_DrawImage1BPP(82, 100 + 4 * 38, BMP_Siji, WHITE, BLACK); //司机
    LCD_DrawImage1BPP(82 + 42 , 100 + 4 * 38, BMP_Caozuo, WHITE, BLACK); //操作
    LCD_DrawImage1BPP(82 + 42 + 42 , 100 + 4 * 38, BMP_Zhuangtai, WHITE, BLACK); //状态
    
    LCD_DrawImage1BPP(82, 100 + 5 * 38, BMP_System, WHITE, BLACK); //系统
    LCD_DrawImage1BPP(82 + 42 , 100 + 5 * 38, BMP_Gongzuo, WHITE, BLACK); //工作
    LCD_DrawImage1BPP(82 + 42 + 42 , 100 + 5 * 38, BMP_Zhuangtai, WHITE, BLACK); //状态
    
    LCD_DrawImage1BPP(82, 100 + 6 * 38, BMP_System, WHITE, BLACK); //系统
    LCD_DrawImage1BPP(82 + 42 , 100 + 6 * 38, BMP_Life, WHITE, BLACK); //LIFE
    ...
    LCD_DrawImage1BPP(82 + 63+ 320, 100 + 38 * 2, BMP_Fuhe, WHITE, BLACK); //负荷
    LCD_DrawImage1BPP(400 - 24+ 320, 100 + 38 * 2, BMP_Baifenhao, WHITE, BLACK); //%
    
    LCD_DrawImage1BPP(82 + 320, 100+38*3, BMP_Fadongji, WHITE, BLACK); //发动机
    LCD_DrawImage1BPP(82 + 63 + 320, 100+38*3, BMP_Mubiao, WHITE, BLACK); //目标
    LCD_DrawImage1BPP(82 + 63 + 42 + 320, 100+38*3, BMP_Youmen, WHITE, BLACK); //油门
    LCD_DrawImage1BPP(720 - 24, 100+38*3, BMP_Baifenhao, WHITE, BLACK); //%

    LCD_DrawImage1BPP(82 + 320, 100 + 38*4, BMP_Fadongji, WHITE, BLACK); //发动机
    LCD_DrawImage1BPP(82 + 63 + 320, 100+ 38*4, BMP_Shiji, WHITE, BLACK); //实际
    LCD_DrawImage1BPP(82 + 63 + 42 + 320, 100+ 38*4, BMP_Youmen, WHITE, BLACK); //油门
    LCD_DrawImage1BPP(720 - 24, 100 + 38*4, BMP_Baifenhao, WHITE, BLACK); //% 
    
    LCD_DrawImage1BPP(82 + 320, 100 + 38*5, BMP_Fadongji, WHITE, BLACK); //发动机
    LCD_DrawImage1BPP(82 + 63 + 320, 100+ 38*5, BMP_Shunshi, WHITE, BLACK); //瞬时
    LCD_DrawImage1BPP(82 + 63 + 42 + 320, 100+ 38*5, BMP_Qihao, WHITE, BLACK); //气耗
    LCD_DrawImage1BPP(720 - 24, 100 + 38*5, BMP_Baifenhao, WHITE, BLACK); //% 
    
    LCD_DrawImage1BPP(82 + 320, 100 + 38*6, BMP_Fadongji, WHITE, BLACK); //发动机
    LCD_DrawImage1BPP(82 + 63 + 320, 100+ 38*6, BMP_Leiji, WHITE, BLACK); //瞬时
    LCD_DrawImage1BPP(82 + 63 + 42 + 320, 100+ 38*6, BMP_Qihao, WHITE, BLACK); //气耗
    LCD_DrawImage1BPP(720 - 24, 100 + 38*6, BMP_Baifenhao, WHITE, BLACK); //% 
    
    
    LCD_DrawImage1BPP(82 + 320, 100 + 38 * 7, BMP_Fadongji, WHITE, BLACK); //发动机
    LCD_DrawImage1BPP(82 + 63 + 320, 100 + 38 * 7, BMP_Jinqi, WHITE, BLACK); //进气
    LCD_DrawImage1BPP(82 + 63 + 42 + 320, 100 + 38 * 7, BMP_Wendu, WHITE, BLACK); //温度
    LCD_DrawImage1BPP(720 - 28, 100 + 38 * 7, BMP_T, WHITE, BLACK); //℃
...
void EngineFrame(void) {
    ...
    LCD_Clear();
    LCD_DrawRect(0, 70, 800, 2, YELLOW); //顶部横线
    LCD_DrawImage1BPP(130 + 200 - 15, 130 - 85, BMP_Energe, WHITE, BLACK); //发动机
    ...
    LCD_DrawImage1BPP(82, 100, BMP_Chaojidianrong, WHITE, BLACK); //超级电容
    LCD_DrawImage1BPP(82 + 84, 100, BMP_Zong, WHITE, BLACK); //总
    LCD_DrawImage1BPP(82 + 84+21, 100, BMP_DY, WHITE, BLACK); //电压
    LCD_DrawImage1BPP(400 - 32, 100, BMP_v, WHITE, BLACK); //V

    LCD_DrawImage1BPP(82 + 320, 100, BMP_Chaojidianrong, WHITE, BLACK); //超级电容
    LCD_DrawImage1BPP(82 + 320 + 84, 100, BMP_Zong, WHITE, BLACK); //总
    LCD_DrawImage1BPP(82 + 320 + 84 + 21, 100, BMP_DL, WHITE, BLACK); //电压
    LCD_DrawImage1BPP(720 - 32, 100, BMP_a, WHITE, BLACK); //A
...
void FuzhuUpdate(void) {
    ...
    print_SZ_1(82 + 270 + 320 - 52, 100 - 8 + 38, DCDC_Warn_code, 3, 0, WHITE); //故障码
}
...
void BatteryUpdate(unsigned char index) {
    ...
    if (index == 0) {
        for (j = 0; j < 5; j++) {
            for (i = 0; i < 10; i++) {
                print_SZ_1(65 + j * 160, 46 + 70 + 36 * i, Battery_voltage[j * 10 + i], 3, 2, GREEN); //单体电压
            }
        }
    }
    ...
    if (index == 3) {
        for (j = 0; j < 5; j++) {
            for (i = 0; i < 10; i++) {
                updata_T(65 + 23 + j * 160, 46 + 70 + 36 * i, GREEN, Battery_temp[j * 10 + i], 1, 40); //单体温度
            }
        }
    }
