...
extern unsigned int Generator;//发电机电流

extern unsigned char Motor_Temperature; //电机温度
extern unsigned char Inverter_t; //逆变器温度
extern unsigned char Generator_Temperature; //发电机温度
extern unsigned char Generator_Inverter_t; //发电机逆变器温度
...
extern unsigned long Engine_oil_consume; //发动机累计气耗
extern unsigned char Engine_oil_consume_instant; //发动机瞬时气耗
...
extern unsigned char Parameter1;//调制参数1
extern unsigned char Parameter2;//调制参数2
extern unsigned char Parameter3;//调制参数3
extern unsigned char Parameter4;//调制参数4
extern unsigned char Parameter5;//调制参数5
extern unsigned char Parameter6;//调制参数6
extern unsigned char Parameter7;//调制参数7
extern unsigned char Parameter8;//调制参数8

extern DATA_BIT CAN_KEY[4];
#define  Contraller_ON    CAN_KEY[0].bit1
#define  Gear_N           CAN_KEY[0].bit2  
#define  Gear_R           CAN_KEY[0].bit3  
#define  Gear_D           CAN_KEY[0].bit4  
#define  Mode_S           CAN_KEY[0].bit5  
#define  Hybrid           CAN_KEY[0].bit6  
#define  Electric         CAN_KEY[0].bit7  
#define  High_Voltage     CAN_KEY[0].bit8  

#define  Capacitance_Kt   CAN_KEY[1].bit0
#define  Capacitance_Kc   CAN_KEY[1].bit1  
#define  Battery_Kt       CAN_KEY[1].bit2
#define  Battery_Kc       CAN_KEY[1].bit3  
#define  AC               CAN_KEY[1].bit4  
#define  Charge_Check     CAN_KEY[1].bit5  
#define  Engieen_ON       CAN_KEY[1].bit6
#define  Brake_Pedal      CAN_KEY[1].bit7 

extern unsigned char Moto_status;//电机状态
extern unsigned char Generator_status;//发电机状态
extern unsigned char Car_status;//正常状态
...
extern unsigned char Battery_number_H; //高压电池编号
extern unsigned char Battery_case_H; //高压电池箱号
extern unsigned int Battery_single_L; //电池单体低电压
extern unsigned char Battery_number_L; //高压电池编号
extern unsigned char Battery_case_L; //高压电池箱号
extern unsigned char Battery_number_t; //最高电池温度编号
extern unsigned char Battery_case_t; //高温电池箱号


extern unsigned int Battery_temp[24];//电池单体温度
extern unsigned int Battery_voltage[96];//电池单体电压
...
extern unsigned char DCDC_Warn_code_double;//双向DCDC故障代码
extern unsigned char DCDC_Warn_code_oil;//油泵DCDC故障代码
extern unsigned char DCDC_Warn_code_gas;//气泵DCDC故障代码
