...
void SM_Logic(void) {
    ...
    if (task == 0) {
        ...
        if (temp < 25)
            ...
            sm_new_value[4] = (unsigned int) ((temp - 25) * 115.2 / 20);
        else if (temp < 180)
            sm_new_value[4] = (unsigned int) ((temp - 140) * 115.2 / 10 + 691);            
        ...
        if (temp < 25)
            ...
            sm_new_value[2] = (unsigned int) ((temp - 25) * 115.2 / 20);
        else if (temp < 180)
            sm_new_value[2] = (unsigned int) ((temp - 140) * 115.2 / 10 + 691);            
