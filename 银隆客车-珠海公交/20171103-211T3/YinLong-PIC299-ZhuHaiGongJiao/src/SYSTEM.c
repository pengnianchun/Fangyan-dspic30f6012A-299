...
void PCAN_DMC(void) {
    ...
    CAN_DATA.bit1 = !LED1; //前门状态
    CAN_DATA.bit2 = LED1;
    CAN_DATA.bit3 = (!LED2 && !fKH1); //中门状态和后舱门状态
...
static void CAN_DATA_Init(void) {
    ...
    if (NodeCount[4] == CAN_TIME) {
        ...
        DC1positive_Temp = 40; //充电插头DC1+温度
        DC1negative_Temp = 40; //充电插头DC1-温度
        DC2positive_Temp = 40; //充电插头DC2+温度
        DC2negative_Temp = 40; //充电插头DC2-温度
        Ohm_Positive = 0; //总正绝缘阻值 
        Ohm_Negative = 0; //总正绝缘阻值 
        Energe_Rest = 0; //剩余能量
        BMS_Status_Flag5 = 0;
        BMS_Status_Flag6 = 0;
        DC3positive_Temp = 40; //充电插头DC3+温度
        DC3negative_Temp = 40; //充电插头DC3-温度
        DC4positive_Temp = 40; //充电插头DC4+温度
        DC4negative_Temp = 40; //充电插头DC4-温度
        BMS_KtStatus_Flag5 = 0; //继电器状态5
        ChargeSet_Times1 = 0;
        ChargeSet_Times2 = 0;
        ChargeSet_Times3 = 0;
        ChargeSet_Times4 = 0;*/
