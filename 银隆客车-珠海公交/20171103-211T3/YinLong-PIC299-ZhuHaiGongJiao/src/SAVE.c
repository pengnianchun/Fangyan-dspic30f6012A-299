...
unsigned int _EEDATA(2) EE_TOTAL_MILES_LOW_1[16] = {
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 0) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 1) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 2) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 3) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 4) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 5) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 6) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 7) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 8) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 9) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 10) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 11) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 12) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 13) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 14) ? (1) : (0))),
    (unsigned int)((TOTAL_MILES / 16) + (((TOTAL_MILES % 16) > 15) ? (1) : (0))),
};
...
//总里程数高位EEROM
unsigned int _EEDATA(2) EE_TOTAL_MILES_HIGH_1 = (unsigned int)(TOTAL_MILES >> 16);
unsigned int _EEDATA(2) EE_TOTAL_MILES_HIGH_2 = (unsigned int)(TOTAL_MILES >> 16);
unsigned int _EEDATA(2) EE_TOTAL_MILES_HIGH_3 = (unsigned int)(TOTAL_MILES >> 16);
...
void EEROM_ReadBackLight(void) {
    ...
    dump[1] = EEROM_ReadWord(__builtin_tbladdress(&EE_BACKLIGHT_2));
    dump[2] = EEROM_ReadWord(__builtin_tbladdress(&EE_BACKLIGHT_3));
