...
//液晶屏符号片显示
#define  LCD_LED1        0      //ABS
#define  LCD_LED2        0      //ASR
#define  LCD_LED3        0      //整车故障
#define  LCD_LED3        0      //后舱门
#define  LCD_LED4        0      //水位报警
#define  LCD_LED5        0      //左前蹄片
#define  LCD_LED6        0      //右前蹄片
#define  LCD_LED7        0      //左后蹄片
#define  LCD_LED8        0      //右后蹄片
#define  LCD_LED9        0      //前门应急阀
#define  LCD_LED10       0      //中门应急阀
#define  LCD_LED11       0      //下客门铃
#define  LCD_LED12       0      //安全带报警
#define  LCD_LED13       0      //安全门报警
#define  LCD_LED14       0      //重力报警
#define  LCD_LED15       0      //0
#define  LCD_LED16       0      //0
#define  LCD_LED17       0      //0
#define  LCD_LED18       0      //0
#define  LCD_LED19       0      //0
#define  LCD_LED20       0      //0
...
extern unsigned int NodeCount[NODE_NUMBER]; //CAN节点离线计数
...
extern unsigned char Air_Power; //功率
...
extern unsigned char DC3positive_Temp; //充电插头DC3+温度
extern unsigned char DC3negative_Temp; //充电插头DC3-温度
extern unsigned char DC4positive_Temp; //充电插头DC4+温度
extern unsigned char DC4negative_Temp; //充电插头DC4-温度
extern unsigned char BMS_KtStatus_Flag5;//继电器状态5
...
extern unsigned int ChargeSet_Times1;
extern unsigned int ChargeSet_Times2;
extern unsigned int ChargeSet_Times3;
extern unsigned int ChargeSet_Times4;
...
typedef union {
    ...
    struct {
        ...
        unsigned double2_1 : 2;
        unsigned double2_2 : 2;
        unsigned double2_3 : 2;
        unsigned double2_4 : 2;

        unsigned double3_1 : 2;
        unsigned double3_2 : 2;
        unsigned double3_3 : 2;
        unsigned double3_4 : 2;

        unsigned four4_1 : 4;
        unsigned four4_2 : 4;

        unsigned double5_1 : 2;
        unsigned double5_2 : 2;
        unsigned double5_3 : 2;
        unsigned double5_4 : 2;
...
extern _CAN_0x0CFE5A2F CAN_0xCFE5A2F;
...
extern DM1 CAN_18FECA2F;
extern unsigned char CAN_18FECA2F_len;
