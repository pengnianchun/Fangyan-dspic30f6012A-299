...
//ECAS上升
__prog__ const unsigned char * ECASTS[] = {BMP_e, BMP_c, BMP_a, BMP_s, BMP_Shangsheng, 0};
//ECAS下降
...
//上车呼叫
__prog__ const unsigned char * SCHJ[] = {BMP_Shangsheng, BMP_Chesu, BMP_Hujiao, 0};
//下车呼叫
__prog__ const unsigned char * XCHJ[] = {BMP_Xiajiang, BMP_Chesu, BMP_Hujiao, 0};
//残疾人电源
__prog__ const unsigned char * CJRDY[] = {BMP_Canjiren, BMP_Dianyuan,0};
//踏板信号
__prog__ const unsigned char * TBXH[] = {BMP_Taban, BMP_Xinhao,0};
//踏板开
__prog__ const unsigned char * TBK[] = {BMP_Taban, BMP_Kai,0};
/******************************************************************************/
