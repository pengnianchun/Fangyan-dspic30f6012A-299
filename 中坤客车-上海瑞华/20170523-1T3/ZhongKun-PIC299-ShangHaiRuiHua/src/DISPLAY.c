...
//单位
x=222;y=138;
    lcd_show_8dot(x-16,   y-7, Bmp_kpa, WHITE,0x0000);  
x=320;y=138;
...
if(Tire_BK_ST){
    lcd_show_8dot( x-50, y-18, Bmp_LTai,WHITE,0x0000);
    lcd_show_8dot( x-12, y-8,  Bmp_BK,  WHITE,0x0000);//BK  
x=602;y=218;
    lcd_show_8dot(x-16,   y-7, Bmp_kpa, WHITE,0x0000);  
x=700;y=218;
    lcd_show_8dot(x-8,    y-8, Bmp_deg, WHITE,0x0000); 
...
//左前轮
x=169-32;y=342-9;
print_SZ_2(x,y,Tire_Press[0]*5.5,4,0,YELLOW);//
x=279-32;y=342-9;
print_SZ_2(x,y,Tire_Temp[0]*0.03125,4,0,YELLOW);//
//报警
x=362-28;y=342-9;
     if(Tire_fault[0]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[0]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[0]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[0]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示 
//右前轮
x=169-32;y=138-9;
print_SZ_2(x,y,Tire_Press[1]*5.5,4,0,YELLOW);//
x=279-32;y=138-9;
print_SZ_2(x,y,Tire_Temp[1]*0.03125,4,0,YELLOW);//
x=362-28;y=138-9;
     if(Tire_fault[1]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[1]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[1]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[1]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示
//左后左轮1
x=549-32;y=342-9;
print_SZ_2(x,y,Tire_Press[2]*5.5,4,0,YELLOW);//
x=659-32;y=342-9;
print_SZ_2(x,y,Tire_Temp[2]*0.03125,4,0,YELLOW);//
x=742-28;y=342-9;
     if(Tire_fault[2]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[2]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[2]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[2]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示
//左后右轮2
x=549-32;y=342-9-40;
print_SZ_2(x,y,Tire_Press[3]*5.5,4,0,YELLOW);//
x=659-32;y=342-9-40;
print_SZ_2(x,y,Tire_Temp[3]*0.03125,4,0,YELLOW);//
x=742-28;y=342-9-40;
     if(Tire_fault[3]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[3]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[3]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[3]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示
//右后左轮1
x=549-32;y=178-9;
print_SZ_2(x,y,Tire_Press[4]*5.5,4,0,YELLOW);//
x=659-32;y=178-9;
print_SZ_2(x,y,Tire_Temp[4]*0.03125,4,0,YELLOW);//
x=742-28;y=178-9;
     if(Tire_fault[4]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[4]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[4]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[4]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示
//右后右轮2
x=549-32;y=178-9-40;
print_SZ_2(x,y,Tire_Press[5]*5.5,4,0,YELLOW);//
x=659-32;y=178-9-40;
print_SZ_2(x,y,Tire_Temp[5]*0.03125,4,0,YELLOW);//
x=742-28;y=178-9-40;
     if(Tire_fault[5]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[5]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[5]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[5]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示
//备胎
if(Tire_BK_ST){
x=549-32;y=218-9;
print_SZ_2(x,y,Tire_Press[6]*5.5,4,0,YELLOW);//
x=659-32;y=218-9;
print_SZ_2(x,y,Tire_Temp[6]*0.03125,4,0,YELLOW);//
x=742-28;y=218-9;
     if(Tire_fault[6]==0x20)    { lcd_show_8dot(x,y, Bmp_GYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//超压
else if(Tire_fault[6]==0x40)    { lcd_show_8dot(x,y, Bmp_OK,  GREEN,0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//正常 
else if(Tire_fault[6]==0x60)    { lcd_show_8dot(x,y, Bmp_DYa, RED,  0x0000);LCD_DrawRect(x+40,y,16, 18,0x0000); }//低压 
else if(Tire_fault[6]==0x80)    { lcd_show_8dot(x,y, Bmp_CDYa,RED,  0x0000);                                    }//超低压 
else                            { lcd_show_8dot(x,y, Bmp_CDYa,BLACK,0x0000);                                    }//不显示
}
}
