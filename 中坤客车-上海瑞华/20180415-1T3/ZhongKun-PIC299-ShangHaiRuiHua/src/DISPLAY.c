...
void disp_baojing(void) {
    ...
    if (IN33 && M_ON ) color = RED;
    else color = GRAY;
    LCD_DrawImage1BPP(6 + 66 * 0 + 8, 32-24, Bmp_baojing2222[2], color, BLACK); //安全门

    if (IN34) color = RED;
    else color = GRAY;
    if (color_old[1] != color) {
        color_old[1] = color;
        //LCD_DrawImage1BPP(6 + 66, 10, Bmp_baojing[10], color, BLACK); //前门应急阀1
    }
    ...
    if (color_old[2] != color) {
        color_old[2] = color;
        LCD_DrawImage1BPP(6 + 66, 96-24, Bmp_baojing[12], color, BLACK); //中门应急阀1
    }
    ...
    //if (!IN36 && READY) color = RED;
    if (!IN36 && !LED18 && READY && (VCU_Gear==13 || VCU_Gear==14) ) color = RED;//  
    else color = GRAY;
    //if (color_old[12] != color) {
    //    color_old[12] = color;
        LCD_DrawImage1BPP(140 + 66 * 0, 74 - 5, Bmp_baojing2222[0], color, BLACK); //重力感应
    //}
    
    if (IN36 && IN37 && (pSpeed > 5) && M_ON) color = RED;
    else color = GRAY;
    //if (color_old[6] != color) {
    //    color_old[6] = color;
        LCD_DrawImage1BPP(140 + 66 * 0, 10, Bmp_baojing2222[1], color, BLACK); //安全带
    //}
    ...
    if (alarm_update_flag == 0) { //3S 更新一次 
        ...
        switch (al_index) {
            ...
            case 13:
                ...
                if (CHARGE_OVERTIME) {
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_13, YELLOW, BLACK); //预充超时
            ...
            case 14:
                ...
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_14, YELLOW, BLACK); //
            ...
            case 15:
                ...
                if (BAT_SOC_Fault > 0) {
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_15, YELLOW, BLACK); //
                    ...
                    //LCD_DrawRect(x + 11 + 11 + 11 + 42, y, 100, 36, BLACK);
                    LCD_DrawRect(x + 14 + 14 + 14 + 42, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            ...
            case 16:
                ...
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_16, YELLOW, BLACK); //
            ...
            case 17:
                ...
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_17, YELLOW, BLACK); //
            ...
            case 18:
                ...
                if (BAT_Temp_Fault > 0) {
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_18, YELLOW, BLACK); //
            ...
            case 19:
                ...
                if (BAT_SOC_Fault == 3) {
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_19, YELLOW, BLACK); //   
            ...
            case 20:
                ...
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_20, YELLOW, BLACK); //
            ...
            case 21:
                ...
                //if(1){ 
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_21, YELLOW, BLACK); //
            ...
            case 22:
                ...
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_22, YELLOW, BLACK); //
            ...
            case 23:
                ...
                if (BAT_Lock_Fault > 0) {
                //if(1){
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_23, YELLOW, BLACK); //
            ...
            case 31:
                al_index = 32;
                if (!IN36 && !LED18 && READY && (VCU_Gear==13 || VCU_Gear==14) ) { // 
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_24, YELLOW, BLACK); //请正确停车
                    LCD_DrawRect(x + 21 + 42 + 42, y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }
            case 32:
                al_index = 33;
                if (IN36 && IN37 && (pSpeed > 5) && M_ON) {  
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_25, YELLOW, BLACK); //安全带未系
                    LCD_DrawRect(x + 21*3 + 42 , y, 100, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }  
            case 33:
                al_index = 0;
                if (IN33 && M_ON) {  
                    LCD_DrawImage4BPP(x, y + 8, Bmp_Display_bj_26, YELLOW, BLACK); //安全门开
                    LCD_DrawRect(x + 21*3 + 21 , y, 130, 36, BLACK);
                    alarm_update_flag = 1;
                    break;
                }              
...
void mainFrame(void) {
    ...
    //LCD_DrawImage1BPP(615 - 22 + 11, 365 - 50 + 10 + 38, BMP_m, WHITE, BLACK); //
        LCD_DrawImage4BPP(225 + 83 + 83 + 2, 365 - 50 + 10 + 38, Bmp_JYDZ, WHITE, BLACK); //绝缘
        LCD_DrawImage4BPP(615 - 34, 365 - 50 + 10 + 38, Bmp_KR, WHITE, BLACK); //KR
...
void frmMain(void) {
    if (f_index == 0) { //只更新一次
      ...
      //updata_DAT(480 + 30, 318 + 38, TM_Feedback_NM, 0.1, 2000, WHITE, 4, 0);
        print_SZ_1(480 + 30-16, 318 + 38, BMS_Ohm, 5, 0, WHITE);//绝缘电阻
    } else if (f_index == 3) {
        f_index = 4;
        disp_miles();
...
void ICFrame(unsigned char index) { //仪表框架
    ...
    if (index == 1) {
        ...
        //长条灯2
        LCD_DrawImage1BPP(35, 75 + 25 * 12, Bmp_GGAO, WHITE, BLACK);//广告灯箱
        LCD_DrawImage1BPP(35 + 42*2, 75 + 25 * 12, BMP_IC_Kaiguan, WHITE, BLACK);
        ...
        //重力报警
        //LCD_DrawImageSBPP(285, 75 + 25 * 0, 42, ZLBJ, WHITE, BLACK);
        //ABS状态
        ...
        //安全带
        //LCD_DrawImageSBPP(285, 75 + 25 * 7,21, Bmp_AQDai, WHITE, BLACK);             
        ...
        //安全门
        LCD_DrawImageSBPP(535, 75 + 25 * 0, 21, Bmp_AQMen, WHITE, BLACK);       
        //前门应急阀
        LCD_DrawImageSBPP(535, 75 + 25 * 1, 21, QMYJF, WHITE, BLACK);   
        //中门应急阀
        LCD_DrawImageSBPP(535, 75 + 25 * 2, 21, ZMYJF, WHITE, BLACK);   
        //重力报警
        LCD_DrawImageSBPP(535, 75 + 25 * 3, 42, ZLBJ, WHITE, BLACK);    
        //安全带
        LCD_DrawImageSBPP(535, 75 + 25 * 4, 21, Bmp_AQDai, WHITE, BLACK);   
        ...
        //POUT12
        //低速报警
        LCD_DrawImageSBPP(60, 75 + 25 * 11, 42, DSBJ, WHITE, BLACK);   
        //左近光灯
        ...
        //前路牌
        LCD_DrawImage1BPP(60, 75 + 25 * 5, Bmp_GGAO, WHITE, BLACK);//广告灯箱1
        print_SZ_2(60 + 84, 75 + 25 * 5, 1, 1, 0, WHITE);
        //LCD_DrawImage1BPP(60 + 42, 75 + 25 * 5, Bmp_TV, WHITE, BLACK);
        //前门关输出
        ...
        //硬盘电源
        LCD_DrawImage1BPP(60, 75 + 25 * 12, Bmp_GGAO, WHITE, BLACK);//广告灯箱2
        print_SZ_2(60 + 84, 75 + 25 * 12, 2, 1, 0, WHITE);
        //LCD_DrawImage1BPP(60 + 21, 75 + 25 * 12, Bmp_TV, WHITE, BLACK);
        //位置灯
        LCD_DrawImage1BPP(60, 75 + 25 * 13, BMP_Weizhi, WHITE, BLACK);
