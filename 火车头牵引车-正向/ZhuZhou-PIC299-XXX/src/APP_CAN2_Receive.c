...
unsigned char FMI;
/******************************************/
_CAN_0x141 CAN_0x141;
_CAN_0x121 CAN_0x121;
_CAN_0x113 CAN_0x113;
_CAN_0x202 CAN_0x202;
_CAN_0x239 CAN_0x239 = {
    {0, 12000, 40, 40, 0, 0, 0, 0, 510}
};
_CAN_0x233 CAN_0x233;
_CAN_0x23D CAN_0x23D;
_CAN_0x235 CAN_0x235;
_CAN_0x237 CAN_0x237;
_CAN_0x213 CAN_0x213 = {
    {0, 8000}
};
_CAN_0x215 CAN_0x215;
_CAN_0x21A CAN_0x21A = {
    {40, 0, 0, 40}
};
_CAN_0x217 CAN_0x217;
_CAN_0x207 CAN_0x207;
_CAN_0x219 CAN_0x219;
_CAN_0x7E0 CAN_0x7E0;
    ...
    if (C2RX0CONbits.RXFUL) { //数据有效
        ...
        switch (msg.id) {  
            case 0x141:
                Vcan_count = 0;               
                for (i = 2; i < 8; i++) {
                    CAN_0x141.byte[i] = msg.data[i];
                }
                CAN_0x141.VCU_VehSpd = msg.data[1] + ((unsigned int) (msg.data[0] & 0x7F) << 8);
                CAN_0x141.VCU_VehSpdV = (msg.data[0] >> 7);
                break;
            
            case 0x121:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x121.byte[i] = msg.data[i];
                }
                CAN_0x121.VCU_MtrASpdCtrlReqValV = (msg.data[3] & 0x01);
                CAN_0x121.VCU_MtrASpdCtrlReq = (msg.data[3] >> 1) + ((unsigned int) msg.data[2] << 7);
                CAN_0x121.VCU_LstComWithMCU = (msg.data[5] & 0x01);
                CAN_0x121.VCU_DCDCStsWrning = ((msg.data[5] >> 1) & 0x01);
                CAN_0x121.VCU_VehicleStatus = ((msg.data[5] >> 2) & 0x03);
                CAN_0x121.VCU_VacuumPresWarn = ((msg.data[5] >> 4) & 0x03);
                CAN_0x121.VCU_MtrATqCtrlReq = (msg.data[5] >> 6) + ((unsigned int) msg.data[4] << 2);
                break;
                
            case 0x113:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x113.byte[i] = msg.data[i];
                }
                CAN_0x113.VCU_Flt = (msg.data[1] & 0x07);
                CAN_0x113.VCU_WorkingSts = ((msg.data[1] >> 3) & 0x07);
                CAN_0x113.VCU_DCDCStsWrning = (msg.data[1] >> 6) + ((unsigned int) msg.data[0] << 2);
                break;
                
            case 0x202:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x202.byte[i] = msg.data[i];
                }
                break;
            ...
            case 0x239:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x239.byte[i] = msg.data[i];
                }
                CAN_0x239.MCU_MtrSpd = msg.data[1] + ((unsigned int) (msg.data[0] & 0x7F) << 8);
                CAN_0x239.MCU_MtrSpdV = (msg.data[0] >> 7);
                CAN_0x239.MCU_MtrDirSts = ((msg.data[4] >> 2) & 0x01);
                CAN_0x239.MCU_MtrModSts = ((msg.data[4] >> 3) & 0x07);
                CAN_0x239.MCU_MtrCtrlTmpV = ((msg.data[4] >> 5) & 0x01);
                CAN_0x239.MCU_MtrTmpV = ((msg.data[4] >> 7) & 0x01);
                CAN_0x239.MCU_MtrDlvrdTrq = msg.data[5] + ((unsigned int) (msg.data[4] & 0x03) << 8);
                CAN_0x239.MCU_MtrOptPwrV = ((msg.data[6] >> 2) & 0x01);
                CAN_0x239.MCU_MtrDlvrdTrqV = ((msg.data[6] >> 3) & 0x01);
                CAN_0x239.MCU_MtrAInvrSts = ((msg.data[6] >> 4) & 0x01);
                CAN_0x239.MCU_MtrSysFltSts = ((msg.data[6] >> 5) & 0x07);
                CAN_0x239.MCU_MtrOptPwr = msg.data[7] + ((unsigned int) (msg.data[6] & 0x03) << 8);
                break;
                
            case 0x233:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x233.byte[i] = msg.data[i];
                }
                break;
            ...
            case 0x23D:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x23D.byte[i] = msg.data[i];
                }
                CAN_0x23D.MCU_MtrInverRatVol = msg.data[1] + ((unsigned int) msg.data[0] << 8);
                CAN_0x23D.MCU_MtrCntrlRatCrnt = msg.data[3] + ((unsigned int) msg.data[2] << 8);
                break;

            case 0x235:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x235.byte[i] = msg.data[i];
                }
                break;
            ...
            case 0x213:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x213.byte[i] = msg.data[i];
                }
                CAN_0x213.BMS_HVBatProVol = msg.data[1] + ((unsigned int) msg.data[0] << 8);
                CAN_0x213.BMS_BatPckCrnt = msg.data[3] + ((unsigned int) msg.data[2] << 8);
                CAN_0x213.BMS_HVBatSOC = msg.data[4];
                break;

            case 0x215:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x215.byte[i] = msg.data[i];
                }
                CAN_0x215.BMS_BatPckCellMaxVol = msg.data[1] + ((unsigned int) msg.data[0] << 8);
                CAN_0x215.BMS_BatPckCellMinVol = msg.data[5] + ((unsigned int) msg.data[4] << 8);
                break;

            case 0x21A:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x21A.byte[i] = msg.data[i];
                }
                break;
            ...
            case 0x217:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x217.byte[i] = msg.data[i];
                }
                CAN_0x217.BMS_PosIsoRes = msg.data[1] + ((unsigned int) msg.data[0] << 8);
                CAN_0x217.BMS_NegIsoRes = msg.data[3] + ((unsigned int) msg.data[2] << 8);
                break;

            case 0x207:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x207.byte[i] = msg.data[i];
                }
                CAN_0x207.BMS_OvDischCnt = msg.data[2] + ((unsigned int) msg.data[1] << 8);  
                CAN_0x207.BMS_ChrgCnt = msg.data[5] + ((unsigned int) msg.data[4] << 8); 
                CAN_0x207.BMS_BatPckSysFltCod = msg.data[3];
                break;
                
            case 0x219:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x219.byte[i] = msg.data[i];
                }
                CAN_0x219.BMS_SurpMilea = msg.data[3] + ((unsigned int) (msg.data[2] & 0x03) << 8);
                break;
                
            case 0x7E0:
                Vcan_count = 0;
                for (i = 0; i < 8; i++) {
                    CAN_0x7E0.byte[i] = msg.data[i];
                }
                break;
