...
void PCAN_0x18F43A17(void) {
    ...
    CAN_DATA.bit4 = mKL5;
    CAN_DATA.bit5 = LED18;
    CAN_DATA.bit6 = (IN19 || IN20 || IN27 || IN28);
    CAN_DATA.bit7 = WAKE_ON; 
    CAN_DATA.bit8 = WAKE_ACC;
    msg.data[1] = CAN_DATA.byte;
    ...
    if (mADR[0] < 9)
        ...
        temp = 40 + (mADR[0] - 88)*0.56;
    else if (mADR[0] < 155)
        temp = 40 + (mADR[0] - 124)*0.645;
    else if (mADR[0] < 184)
        temp = 40 + (mADR[0] - 155)*0.69;
    else if (mADR[0] < 200)
        temp = 40 + (mADR[0] - 184)*1.25;
    else
        temp = 120;
    msg.data[2] = temp;
    ...
    if (mADR[1] < 9)
        ...
        temp = 40 + (mADR[1] - 88)*0.56;
    else if (mADR[1] < 155)
        temp = 40 + (mADR[1] - 124)*0.645;
    else if (mADR[1] < 184)
        temp = 40 + (mADR[1] - 155)*0.69;
    else if (mADR[1] < 200)
        temp = 40 + (mADR[1] - 184)*1.25;
    else
        temp = 120;
    msg.data[3] = temp; 
    ...
    CAN_DATA.bit2 = LED17; 
    CAN_DATA.bit3 = LED24; 
    CAN_DATA.bit4 = (WAKE_ON && IN10);
    CAN_DATA.bit5 = (WAKE_ON && IN9);
    CAN_DATA.bit6 = WAKE_Danger;
    CAN_DATA.bit7 = LED19; 
    CAN_DATA.bit8 = LED20;
    msg.data[4] = CAN_DATA.byte;
    ...
    msg.data[6] = (((CAN_0x0CF101A7.Gear == 1) || (CAN_0x0CF101A7.Gear == 2)) && !fKL8);
    msg.data[7] = Life++;
    msg.len = 8;
    msg.type = 0;
    CAN2_SendMessage(&msg);
...
void PCAN_0x18F54A17(void) {
    CAN_MESSAGE msg;
    unsigned long temp;
    msg.id = 0x18F54A17;

    temp = e_total_miles / 10 * 8;
